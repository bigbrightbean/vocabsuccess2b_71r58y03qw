...
var questions = [
    ...
    {
        id: 3,
        question: "His __________ voice boomed through the hall, capturing everyone's attention with its resonance and power.",
        chinese_question: "他 __________ 的声音在大厅里回响，凭借其共鸣和力量吸引了每个人的注意。",
        answers: [
        ...
        correctAnswer: "C",
        explanation: "(C) 'rotund' means 'having a full, rich, and deep sound." +
            "<br><br>" +
            "(A) 'faint' means (of a sight, smell, or sound) barely noticeable." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '洪亮的' 意味着 '拥有丰满、丰富和深沉的声音。" +
            "<br><br>" +
