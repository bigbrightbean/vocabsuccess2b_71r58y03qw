...
var questions = [
    {
        ...
        answers: [
            { option: "A", answer: "celebrating", chinese_answer: "庆祝", chinese_romanization: "qìngzhù" },
            { option: "B", answer: "supporting", chinese_answer: "支持", chinese_romanization: "zhīchí" },
            { option: "C", answer: "praising", chinese_answer: "赞美", chinese_romanization: "zànměi" },
            { option: "D", answer: "disparaging", chinese_answer: "贬低", chinese_romanization: "biǎndī" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'disparaging' figuratively means to regard or represent as being of little worth." +
            "<br><br>" +
            "(A) 'celebrating' means to acknowledge (a significant or happy day or event) with a social gathering or enjoyable activity." +
            "<br><br>" +
            "(B) 'supporting' means to give assistance to." +
            "<br><br>" +
            "(C) 'praising' means to express warm approval or admiration of.",
        chinese_explanation: "(D) '贬低' 在此语境下比喻认为或表现出某事物没有价值。" +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "lament", chinese_answer: "哀悼", chinese_romanization: "āidào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'lament' means to express sorrow, mourning, or regret." +
            "<br><br>" +
            ...
            "<br><br>" +
        chinese_explanation: "(D) '哀悼' 意味着表达悲伤、哀悼或遗憾。" +
            "<br><br>" +
            "(A) '庆祝' 意味着通过社交聚会或愉快的活动来承认一个重要或快乐的日子或事件。" +
            "<br><br>" +
            "(B) '帮助' 意味着帮助某人。" +
            "<br><br>" +
            "(C) '接受' 意味着同意接受或承担提供的某物。"
    },
    {
        id: 5,
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "mitigate", chinese_answer: "减轻", chinese_romanization: "jiǎnqīng" },
        ...
        explanation: "(C) 'mitigate' means to make less severe or intense." +
            ...
            "<br><br>" +
            "(B) 'prolong' means to extend the duration of." +
            "<br><br>" +
            "(D) 'intensify' means to make something more acute or severe.",
        chinese_explanation: "(C) '减轻' 意味着使某事物不那么严重或强烈。" +
            "<br><br>" +
            "(A) '放大' 意味着使某物看起来更大。" +
            "<br><br>" +
            "(B) '延长' 意味着延长持续时间。" +
