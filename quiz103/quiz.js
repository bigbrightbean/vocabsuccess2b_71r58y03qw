...
var questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "refuted", chinese_answer: "反驳", chinese_romanization: "fǎnbó" },
            { option: "C", answer: "confirmed", chinese_answer: "确认", chinese_romanization: "quèrèn" },
            { option: "D", answer: "ignored", chinese_answer: "忽视", chinese_romanization: "hūshì" }
        ],
        correctAnswer: "B",
        explanation: "(B) 'refuted' means to prove a statement or theory to be wrong or false." +
            "<br><br>" +
            "(A) 'supported' means to bear all or part of the weight of; hold up." +
            "<br><br>" +
            "(C) 'confirmed' means to establish the truth or correctness of something previously believed, suspected, or feared to be the case." +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "forgot", chinese_answer: "忘记", chinese_romanization: "wàngjì" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'coveted' means to yearn to possess or have (something)." +
            ...
            "<br><br>" +
            "(D) 'forgot' means to fail to remember.",
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "calmed", chinese_answer: "平息", chinese_romanization: "píngxí" },
            { option: "C", answer: "misled", chinese_answer: "误导", chinese_romanization: "wùdǎo" },
            { option: "D", answer: "ignored", chinese_answer: "忽视", chinese_romanization: "hūshì" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'prompted' figuratively means to cause or bring about (an action or feeling)." +
            ...
            "<br><br>" +
            "(C) 'misled' means to cause someone to have a wrong idea or impression about someone or something." +
            "<br><br>" +
            "(D) 'ignored' means to refuse to take notice of or acknowledge.",
        chinese_explanation: "(A) '引发' 在此语境下比喻导致或引起（一个行动或感觉）。" +
            "<br><br>" +
            "(B) '平息' 意味着使（某人）平静和安静；安抚。" +
            "<br><br>" +
            "(C) '误导' 意味着使某人对某人或某事有错误的想法或印象。" +
            "<br><br>" +
            "(D) '忽视' 意味着拒绝注意或承认。"
    },
    {
        id: 10,
        question: "He felt __________ by the sarcastic remarks made about his project in front of the entire team.",
        chinese_question: "在整个团队面前关于他项目的讽刺评论让他感到被 __________ 。",
        answers: [
