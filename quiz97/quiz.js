...
var questions = [
    {
        id: 1,
        question: "He chose to __________ an alibi to cover his tracks.",
        chinese_question: "他选择 __________ 一个不在场证明来掩盖自己的行踪。",
        answers: [
                { option: "A", answer: "fabricate", chinese_answer: "编造", chinese_romanization: "biānzào" },
                { option: "B", answer: "uncover", chinese_answer: "揭示", chinese_romanization: "jiēshì" },
                { option: "C", answer: "ignore", chinese_answer: "忽视", chinese_romanization: "hūshì" },
                { option: "D", answer: "confess", chinese_answer: "承认", chinese_romanization: "chéngrèn" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'fabricate' means to invent or concoct something, typically with deceitful intent, used figuratively here." +
                "<br><br>" +
                "(B) 'uncover' means to discover something previously secret or unknown." +
                "<br><br>" +
                "(C) 'ignore' means to refuse to take notice of or acknowledge." +
                "<br><br>" +
                "(D) 'confess' means to admit to something, typically with reluctance.",
        chinese_explanation: "(A) '编造' 意味着发明或编造某物，通常是出于欺骗目的，这里是比喻用法。" +
                "<br><br>" +
                "(B) '揭示' 意味着发现以前秘密或未知的东西。" +
                "<br><br>" +
                "(C) '忽视' 意味着拒绝注意或承认。" +
                "<br><br>" +
                "(D) '承认' 意味着承认某事，通常是勉强的。"
    ...
    {
        id: 2,
    question: "Each department was asked to __________ resources for the upcoming event.",
    chinese_question: "每个部门被要求为即将到来的活动 __________ 资源。",
    answers: [
    ...
    {
        id: 3,
    question: "The newspaper editorial __________ the government's handling of the crisis.",
    chinese_question: "报纸社论 __________ 政府对危机的处理。",
    answers: [
    ...
    {
        id: 5,
    question: "His constant lies and deceit __________ his once honourable character.",
    chinese_question: "他不断的谎言和欺骗 __________ 了他曾经光荣的性格。",
    answers: [
        ...
        { option: "C", answer: "ignored", chinese_answer: "忽视", chinese_romanization: "hūshì" },
        { option: "D", answer: "highlighted", chinese_answer: "强调", chinese_romanization: "qiángdiào" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'sullied' means to damage the purity or integrity of; defile." +
        ...
        "<br><br>" +
        "(D) 'highlighted' means to emphasize or make something prominent.",
