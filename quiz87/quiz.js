...
var questions = [
    ...
    {
        id: 10,
    question: "He would often __________ his achievements in the company newsletter, highlighting every minor success as if it were a groundbreaking discovery.",
    chinese_question: "他经常在公司通讯中 __________ 他的成就，将每一个小小的成功都强调得好像是重大发现。",
    answers: [
        ...
        { option: "D", answer: "vaunt", chinese_answer: "吹嘘", chinese_romanization: "chuīxū" }
    ],
    correctAnswer: "D",
    ...
    chinese_explanation: "(D) '吹嘘' 意味着自夸或赞扬某事，尤其是过分的赞扬。" +
        "<br><br>" +
        "(A) '支吾其词' 意味着说话或行动含糊其辞。" +
        "<br><br>" +
        "(B) '预言' 意味着预言或预测未来的事件。" +
