...
var questions = [
    ...
    answers: [
        { option: "A", answer: "blurred", chinese_answer: "模糊", chinese_romanization: "móhu" },
        { option: "B", answer: "complicated", chinese_answer: "复杂化", chinese_romanization: "fùzá huà" },
        { option: "C", answer: "chiselled", chinese_answer: "开辟", chinese_romanization: "kāipì" },
        { option: "D", answer: "obliterated", chinese_answer: "抹去", chinese_romanization: "mǒqù" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'chiselled' means to shape or define something with effort, used figuratively here." +
        "<br><br>" +
        "(A) 'blurred' means to make or become unclear or less distinct." +
        "<br><br>" +
        "(B) 'complicated' means to make something more difficult or confusing." +
        "<br><br>" +
        "(D) 'obliterated' means to destroy utterly; wipe out.",
    chinese_explanation: "(C) '开辟' 意味着用努力来塑造或定义某物，这里是比喻用法。" +
        "<br><br>" +
        "(A) '模糊' 意味着使变得不清楚或不那么明显。" +
        "<br><br>" +
        "(B) '复杂化' 意味着使某事更困难或更混乱。" +
        "<br><br>" +
        "(D) '抹去' 意味着彻底摧毁；抹去。"
    ...
    answers: [
        ...
        { option: "B", answer: "desert", chinese_answer: "遗弃", chinese_romanization: "yíqì" },
        { option: "C", answer: "coddle", chinese_answer: "溺爱", chinese_romanization: "nì'ài" },
        { option: "D", answer: "mistreat", chinese_answer: "虐待", chinese_romanization: "nüèdài" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'coddle' means to treat with excessive indulgence and care." +
        "<br><br>" +
        "(A) 'abandon' means to give up completely." +
        "<br><br>" +
        "(B) 'desert' means to leave (someone) without help or in a difficult situation." +
        "<br><br>" +
        "(D) 'mistreat' means to treat (a person or animal) badly, cruelly, or unfairly.",
    chinese_explanation: "(C) '溺爱' 意味着过度宠爱和关怀。" +
        "<br><br>" +
        "(A) '放弃' 意味着完全放弃。" +
        "<br><br>" +
        "(B) '遗弃' 意味着在没有帮助的情况下离开某人或陷入困境。" +
        "<br><br>" +
        "(D) '虐待' 意味着对（人或动物）不好、残忍或不公平。"
    },
    {
        id: 6,
    ...
    {
        id: 10,
    question: "She tried to __________ her fears before the big presentation, by practicing her speech and visualizing a successful outcome, so that she would not be overwhelmed by anxiety.",
    chinese_question: "她试图在重要演讲前通过练习演讲和想象成功的结果来 __________ 她的恐惧，这样她就不会被焦虑压倒。",
    answers: [
