...
var questions = [
    ...
    {
        id: 2,
    question: "It was __________ for the villagers to celebrate the harvest with a large feast.",
    chinese_question: "村民们__________地庆祝丰收，举行了一场盛大的宴会。",
    answers: [
    ...
    {
        id: 3,
    question: "The __________ achievements of the company were highlighted during the anniversary celebration.",
    chinese_question: "公司的 __________ 成就被在周年庆典上强调。",
    answers: [
    ...
    {
        id: 8,
        question: "In any emergency situation, ensuring people's safety is of __________ importance.",
        chinese_question: "在任何紧急情况下，确保人们的安全是 __________ 的。",
        answers: [
