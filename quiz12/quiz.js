...
var questions = [
    ...
    {
        id: 10,
        question: "Her __________ way of dressing set her apart from the crowd, making her style both unique and endearing.",
        chinese_question: "她那 __________ 的穿衣风格使她与众不同，让她的风格既独特又令人喜爱。",
        answers: [
            ...
            { option: "C", answer: "trendy", chinese_answer: "时髦的", chinese_romanization: "shímáo de" },
        ...
        explanation: "(A) 'quaint' means attractively unusual or old-fashioned." +
            "<br><br>" +
            "(B) 'contemporary' means belonging to or occurring in the present." +
            "<br><br>" +
            "(C) 'trendy' means very fashionable or up to date." +
            "<br><br>" +
