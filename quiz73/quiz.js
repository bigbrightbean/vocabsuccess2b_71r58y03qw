...
var questions = [
    ...
    answers: [
        ...
        { option: "B", answer: "juxtaposition", chinese_answer: "并置", chinese_romanization: "bìngzhì" },
    ...
    explanation: "(A) 'remark' means a spoken statement or comment." +
        "<br><br>" +
        "(B) 'juxtaposition' means the fact of two things being seen or placed close together with contrasting effect." +
        "<br><br>" +
    ...
    chinese_explanation: "(A) '言论' 意味着口头的陈述或评论。" +
        "<br><br>" +
        "(B) '并置' 意味着两件事物并排放置或靠近的事实，以产生对比效果。" +
        "<br><br>" +
        "(C) '命令' 意味着权威的指令。" +
        "<br><br>" +
        "(D) '道歉' 意味着对冒犯或失败的遗憾承认。"
    ...
    {
        id: 5,
    question: "The challenges we face in the __________ require immediate attention because they are affecting our current operations and decisions.",
    chinese_question: "我们在 __________ 面临的挑战需要立即关注，因为它们正在影响我们当前的运作和决策。",
    answers: [
    ...
    {
        id: 9,
        question: "The __________ of proving his innocence fell upon him after the accusations were made, so he had to gather evidence and present his case.",
        chinese_question: "在受到指控后，证明自己清白的 __________ 落在了他身上，所以他不得不收集证据并陈述他的案情。",
        answers: [
            { option: "A", answer: "opportunity", chinese_answer: "机会", chinese_romanization: "jīhuì" },
            { option: "B", answer: "privilege", chinese_answer: "特权", chinese_romanization: "tèquán" },
            { option: "C", answer: "reward", chinese_answer: "奖励", chinese_romanization: "jiǎnglì" },
            { option: "D", answer: "onus", chinese_answer: "责任", chinese_romanization: "zérèn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'onus' means a burden or responsibility." +
            "<br><br>" +
            "(A) 'opportunity' means a set of circumstances that makes it possible to do something." +
            "<br><br>" +
            "(B) 'privilege' means a special right, advantage, or immunity granted or available only to a particular person or group." +
            "<br><br>" +
            "(C) 'reward' means a thing given in recognition of one's service, effort, or achievement.",
        chinese_explanation: "(D) '责任' 意味着负担或责任。" +
            "<br><br>" +
            "(A) '机会' 意味着使做某事成为可能的一组情况。" +
            "<br><br>" +
            "(B) '特权' 意味着只授予或仅适用于特定人或群体的特殊权利、优势或豁免权。" +
            "<br><br>" +
            "(C) '奖励' 意味着为了表彰一个人的服务、努力或成就而给予的东西。"
    },
    {
        id: 10,
