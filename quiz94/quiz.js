...
var questions = [
    ...
    answers: [
        ...
        { option: "D", answer: "exhaust", chinese_answer: "耗尽", chinese_romanization: "hàojìn" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'recuperate' means to recover from illness or exertion." +
        ...
        "<br><br>" +
        "(D) 'exhaust' means to drain someone of their physical or mental resources.",
    ...
    {
        id: 3,
        question: "The company is looking to __________ its outdated policies to keep up with modern practices.",
        chinese_question: "公司正在寻求 __________ 其过时的政策，以跟上现代实践。",
        answers: [
    ...
    {
        id: 5,
        question: "During the intense argument, she could feel herself __________ her teeth.",
        chinese_question: "在激烈的争论中，她能感觉到自己在 __________ 牙齿。",
        answers: [
                { option: "A", answer: "gnashing", chinese_answer: "咬牙", chinese_romanization: "yǎoyá" },
                ...
                { option: "D", answer: "calming", chinese_answer: "平静", chinese_romanization: "píngjìng" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'gnashing' means to grind one's teeth together, typically as a sign of anger." +
                "<br><br>" +
                "(B) 'praising' means to express warm approval or admiration." +
                "<br><br>" +
                "(C) 'ignoring' means to refuse to take notice of or acknowledge." +
                "<br><br>" +
                "(D) 'calming' means to make someone peaceful and free from disturbance.",
    ...
    {
        id: 6,
    question: "The politician did not hesitate to __________ his support for the new policy.",
    chinese_question: "这位政治家毫不犹豫地 __________ 对新政策的支持。",
    answers: [
