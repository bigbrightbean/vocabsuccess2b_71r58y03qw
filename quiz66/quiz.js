...
var questions = [
    ...
    {
        id: 2,
        question: "Her calm and composed demeanor, always thinking before acting, was the __________ of her brother's fiery and impulsive nature, who often acted without thinking.",
        chinese_question: "她冷静和沉着的举止，总是三思而后行，是她哥哥火爆和冲动性格的 __________，他常常不加思索就行动。",
        answers: [
            { option: "A", answer: "complement", chinese_answer: "补充", chinese_romanization: "bǔchōng" },
            ...
            { option: "D", answer: "antithesis", chinese_answer: "对立面", chinese_romanization: "duìlìmiàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'antithesis' means a person or thing that is the direct opposite of someone or something else." +
            "<br><br>" +
            "(A) 'complement' means a thing that completes or brings to perfection." +
            "<br><br>" +
            "(B) 'reflection' means the throwing back by a body or surface of light, heat, or sound without absorbing it." +
            "<br><br>" +
            "(C) 'example' means a thing characteristic of its kind or illustrating a general rule.",
        chinese_explanation: "(D) '对立面' 意味着某人或某物的直接相反的人或事物。" +
            "<br><br>" +
            "(A) '补充' 意味着完成或完善的事物。" +
            "<br><br>" +
            "(B) '反映' 意味着物体或表面在不吸收的情况下反射光、热或声音。" +
            "<br><br>" +
            "(C) '例子' 意味着某类事物的典型特征或说明一般规则的事物。"
    },
    {
        id: 3,
    ...
    {
        id: 5,
    question: "Having access to the executive lounge is a __________ reserved exclusively for senior managers.",
    ...
    answers: [
        ...
        { option: "D", answer: "indifference", chinese_answer: "冷漠", chinese_romanization: "lěnmò" }
    ],
    correctAnswer: "B",
    ...
    {
        id: 8,
    question: "She raised her hand as a __________ to ask a question, and when the teacher saw her waiting patiently and waving slightly, she nodded in approval and allowed her to speak.",
    chinese_question: "她举起手作为 __________ 提问，当老师看到她耐心等待并轻轻挥手时，她点头表示同意并允许她发言。",
    answers: [
    ...
    explanation: "(C) 'signal' means a gesture, action, or sound that is used to convey information or instructions." +
        ...
        "<br><br>" +
        "(B) 'phenomenon' means a fact or situation that is observed to exist or happen, especially one whose cause or explanation is in question." +
        "<br><br>" +
    ...
    chinese_explanation: "(C) '信号' 意味着用来传达信息或指示的手势、动作或声音。" +
        ...
        "<br><br>" +
        "(B) '现象' 意味着被观察到存在或发生的事实或情况，尤其是其原因或解释成问题的。" +
        "<br><br>" +
        "(D) '表情' 意味着表达思想或感情的过程。"
    },
    {
