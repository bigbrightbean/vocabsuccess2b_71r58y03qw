...
var questions = [
    ...
    answers: [
        { option: "A", answer: "pause", chinese_answer: "暂停", chinese_romanization: "zàntíng" },
    ...
    explanation: "(B) 'interlude' means a period of temporary relief from continuous activity." +
        "<br><br>" +
        "(A) 'pause' means a temporary stop in action or speech." +
        "<br><br>" +
    ...
    {
        id: 3,
    question: "Traffic is usually at its __________ during rush hour in the city.",
    chinese_question: "城市里的交通通常在高峰时段达到 __________。",
    answers: [
    ...
    {
        id: 6,
    question: "The inventor's workshop was cluttered with bizarre __________, each one more unusual than the last.",
    chinese_question: "发明家的工作室里杂乱地堆满了奇怪的 __________，每一个都比上一个更不寻常。",
    answers: [
        { option: "A", answer: "machines", chinese_answer: "机器", chinese_romanization: "jīqì" },
        ...
        { option: "D", answer: "instruments", chinese_answer: "仪器", chinese_romanization: "yíqì" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'contraptions' means machines or devices that appear strange or unnecessarily complicated." +
        "<br><br>" +
        "(A) 'machines' means apparatus using mechanical power and having several parts." +
        "<br><br>" +
        "(C) 'tools' means devices or implements used to carry out a particular function." +
        "<br><br>" +
        "(D) 'instruments' means tools or implements, especially ones for delicate or scientific work.",
    chinese_explanation: "(B) '奇妙装置' 一词意味着看起来奇怪或不必要复杂的机器或装置。" +
        "<br><br>" +
        "(A) '机器' 意味着使用机械动力并有多个部分的设备。" +
        "<br><br>" +
        "(C) '工具' 意味着用于执行特定功能的设备或器具。" +
        "<br><br>" +
        "(D) '仪器' 意味着工具或器具，特别是用于精细或科学工作的器具。"
    },
    {
        id: 7,
