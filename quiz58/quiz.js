...
var questions = [
    ...
    {
        id: 4,
        question: "The parent's __________ to always look both ways before crossing the street helped ensure their children's safety and prevent accidents.",
        chinese_question: "家长的__________，要求过马路前总是左右看，帮助确保了孩子们的安全并防止事故。",
        answers: [
            ...
            { option: "D", answer: "admonition", chinese_answer: "告诫", chinese_romanization: "gàojiè" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'admonition' means a warning or piece of advice to prevent mistakes or encourage proper behavior." +
            "<br><br>" +
            "(A) 'praise' means to express warm approval or admiration." +
            "<br><br>" +
            "(B) 'indifference' means lack of interest, concern, or sympathy." +
            "<br><br>" +
            "(C) 'permission' means consent or authorization to do something.",
        chinese_explanation: "(D) '告诫' 意味着警告或建议，以防止错误或鼓励适当的行为。" +
            "<br><br>" +
            "(A) '赞扬' 意味着表示热烈的认可或钦佩。" +
            "<br><br>" +
            "(B) '冷漠' 意味着缺乏兴趣、关心或同情。" +
