...
var questions = [
    {
        id: 1,
    question: "His __________ attitude made it difficult for others to work with him.",
    chinese_question: "他的__________态度使得别人很难与他共事。",
    answers: [
    ...
    answers: [
        ...
        { option: "B", answer: "couple", chinese_answer: "两个", chinese_romanization: "liǎng gè" },
        { option: "C", answer: "myriad", chinese_answer: "无数的", chinese_romanization: "wúshù de" },
        { option: "D", answer: "handful", chinese_answer: "少量的", chinese_romanization: "shǎoliàng de" }
    ],
    correctAnswer: "C",
