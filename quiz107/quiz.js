...
var questions = [
    ...
    {
        id: 6,
        question: "Many people __________ the decline of traditional values in modern society by lamenting the loss of cultural norms and expressing concern for the future.",
        chinese_question: "许多人通过哀叹文化规范的消失和对未来的担忧 __________ 现代社会传统价值观的衰退。",
        answers: [
            ...
            { option: "D", answer: "bemoan", chinese_answer: "哀叹", chinese_romanization: "āitàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'bemoan' means to express discontent or sorrow over something." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '哀叹' 意味着对某事表示不满或悲伤。" +
            "<br><br>" +
    ...
    {
        id: 7,
        question: "Her kind words seemed to __________ a sense of calm over the entire room, leaving everyone feeling relaxed and reassured.",
        chinese_question: "她温柔的话语似乎 __________ 了整个房间的平静感，使每个人都感到放松和放心。",
        answers: [
            ...
            { option: "C", answer: "emit", chinese_answer: "散发", chinese_romanization: "sànfā" },
            { option: "D", answer: "suppress", chinese_answer: "压制", chinese_romanization: "yāzhì" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'emit' figuratively means to produce and discharge (something, especially gas or radiation)." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '散发' 在此语境下比喻产生并释放（某物，尤其是气体或辐射）。" +
            "<br><br>" +
            "(A) '隐藏' 意味着使看不见；隐藏。" +
            "<br><br>" +
            "(B) '迷惑' 意味着使某人无法清晰思考。" +
