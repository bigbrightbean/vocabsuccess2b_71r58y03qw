...
var questions = [
    ...
    answers: [
        { option: "A", answer: "jeered", chinese_answer: "嘲笑", chinese_romanization: "cháoxiào" },
    ...
    correctAnswer: "A",
    explanation: "(A) 'jeered' means to make rude and mocking remarks, typically in a loud voice, used figuratively here." +
        "<br><br>" +
    ...
    {
        id: 4,
        question: "Her calm demeanour showed that she was not easily __________ by criticism.",
        chinese_question: "她冷静的态度表明她不容易被批评 __________ 。",
        answers: [
