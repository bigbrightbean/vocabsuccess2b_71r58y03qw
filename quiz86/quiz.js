...
var questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "accept", chinese_answer: "承担", chinese_romanization: "chéngdān" },
            { option: "C", answer: "yield to", chinese_answer: "屈服于", chinese_romanization: "qūfú yú" },
            { option: "D", answer: "surmount", chinese_answer: "克服", chinese_romanization: "kèfú" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'surmount' means to overcome a difficulty or obstacle." +
            "<br><br>" +
            ...
            "<br><br>" +
            "(C) 'yield to' means to give way to arguments, demands, or pressure.",
        chinese_explanation: "(D) '克服' 意味着克服困难或障碍。" +
            "<br><br>" +
            "(A) '接受' 意味着愿意并热情地接受或支持。" +
            "<br><br>" +
            "(B) '承担' 意味着同意接收或承担某事。" +
            "<br><br>" +
            "(C) '屈服于' 意味着让步于争论、要求或压力。"
    },
    {
        id: 3,
    ...
    {
        id: 7,
    question: "The city's population continues to __________ as more people leave the countryside and move to urban areas in search of better job opportunities and improved living conditions.",
    chinese_question: "随着更多人离开农村，搬到城市地区寻找更好的工作机会和改善城市的生活条件，这座城市的人口继续 __________。",
    answers: [
    ...
    {
        id: 8,
    question: "She was __________ about her knowledge of the subject, hoping to impress her peers by exaggerating her expertise in hopes to gain their admiration and respect.",
    chinese_question: "她对自己的知识__________，希望通过夸大自己的专业知识给同伴留下深刻印象，以获得他们的钦佩和尊重。",
    answers: [
    ...
    {
        id: 9,
        question: "The lawyer worked hard to __________ the company for violating environmental laws, to make sure they were held accountable for their actions.",
        chinese_question: "律师努力 __________ 该公司违反环境法律的行为，以确保他们为自己的行为负责。",
        answers: [
        ...
        correctAnswer: "D",
        explanation: "(D) 'prosecute' means to institute legal proceedings against someone or something." +
            "<br><br>" +
            "(A) 'defend' means to resist an attack made on someone or something; protect from harm or danger." +
            "<br><br>" +
            "(B) 'release' means to set someone or something free from confinement, restraint, or bondage." +
            "<br><br>" +
            "(C) 'exonerate' means to absolve someone from blame for a fault or wrongdoing.",
        chinese_explanation: "(D) '起诉'一词意味着对某人或某事提起法律诉讼。" +
            "<br><br>" +
            "(A) '辩护' 意味着抵御对某人或某物的攻击；保护免受伤害或危险。" +
            "<br><br>" +
            "(B) '释放' 意味着将某人或某物从监禁、束缚或奴役中释放出来。" +
            "<br><br>" +
            "(C) '免罪' 意味着免除某人的过错或不当行为。"
    },
    {
        id: 10,
    question: "She tends to __________ over decisions and second-guess herself, often making her miss out on good opportunities.",
    chinese_question: "她在做决定时常常 __________ 并且反复猜测自己，因此错过了很多好机会。",
    answers: [
