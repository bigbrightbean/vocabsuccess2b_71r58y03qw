...
var questions = [
    ...
    {
        id: 2,
    question: "The teacher's calm demeanor helped to __________ the students' nerves before the big exam by offering reassuring words and a confident presence.",
    chinese_question: "老师平静的态度通过提供安慰的话语和自信的存在感有助于 __________ 学生在大考前的紧张情绪。",
    answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "purveying", chinese_answer: "供应", chinese_romanization: "gōngyìng" },
            { option: "D", answer: "withholding", chinese_answer: "扣留", chinese_romanization: "kòuliú" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'purveying' means to supply goods, especially food or provisions." +
            "<br><br>" +
            "(A) 'concealing' means to keep something hidden." +
            "<br><br>" +
            "(B) 'destroying' means to put an end to the existence of something." +
            "<br><br>" +
            "(D) 'withholding' means to refuse to give something that is due or desired.",
        chinese_explanation: "(C) '供应' 意味着供应货物，尤其是食品或食物。" +
            "<br><br>" +
            "(A) '隐藏' 意味着保持某物隐藏。" +
            "<br><br>" +
            "(B) '破坏' 意味着结束某物的存在。" +
            "<br><br>" +
            "(D) '扣留' 意味着拒绝给予应得或想要的东西。"
    },
    {
        id: 4,
    ...
    {
        id: 6,
        question: "He worked hard to __________ the support of his colleagues for the new project by presenting clear benefits and addressing their concerns, so that they will be more likely to back the initiative.",
        chinese_question: "他努力工作以通过展示明确的好处和解决他们的担忧来 __________ 同事们对新项目的支持，这样他们更有可能支持这一倡议。",
        answers: [
    ...
    },
    {
        ...
        answers: [
                { option: "A", answer: "scratched", chinese_answer: "划伤", chinese_romanization: "huáshāng" },
                { option: "B", answer: "hidden", chinese_answer: "隐藏", chinese_romanization: "yǐncáng" },
                { option: "C", answer: "erased", chinese_answer: "抹去", chinese_romanization: "mǒqù" },
                { option: "D", answer: "emblazoned", chinese_answer: "醒目地刻有", chinese_romanization: "xǐngmù dì kèyǒu" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'emblazoned' means to display a design prominently or vividly." +
                "<br><br>" +
                "(A) 'scratched' means to make small cuts or marks on a surface." +
                "<br><br>" +
                "(B) 'hidden' means to keep something out of sight." +
                "<br><br>" +
                "(C) 'erased' means to remove all traces of; to wipe out.",
        chinese_explanation: "(D) '醒目地刻有' 意味着突出或生动地展示设计。" +
                "<br><br>" +
                "(A) '划伤' 意味着在表面上做出小的切割或标记。" +
                "<br><br>" +
                "(B) '隐藏' 意味着保密或隐藏某物。" +
                "<br><br>" +
                "(C) '抹去' 意味着去除所有痕迹；抹掉。"
    ...
    {
        id: 8,
    question: "The salesman tried to __________ the customer into buying a more expensive model by praising its features and downplaying the cheaper options.",
    chinese_question: "销售员试图通过赞美其功能并淡化较便宜的选择来 __________ 顾客购买更贵的型号。",
    answers: [
