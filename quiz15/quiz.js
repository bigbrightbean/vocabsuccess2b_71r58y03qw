...
var questions = [
    ...
    {
        id: 5,
        question: "Despite earning a six-figure salary, his __________ nature meant he rarely spent money on anything unnecessary.",
        chinese_question: "尽管他的薪水是六位数，但他 __________ 的性格意味着他很少在不必要的事情上花钱。",
        answers: [
            { option: "A", answer: "frivolous", chinese_answer: "轻浮的", chinese_romanization: "qīngfú de" },
            { option: "B", answer: "lavish", chinese_answer: "奢华的", chinese_romanization: "shēhuá de" },
            { option: "C", answer: "benevolent", chinese_answer: "仁慈的", chinese_romanization: "réncí de" },
            { option: "D", answer: "parsimonious", chinese_answer: "吝啬的", chinese_romanization: "lìnsè de" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'parsimonious' means unwilling to spend money or use resources; stingy or frugal." +
            "<br><br>" +
            "(A) 'frivolous' means not having any serious purpose or value." +
            "<br><br>" +
            "(B) 'lavish' means sumptuously rich, elaborate, or luxurious." +
            "<br><br>" +
            "(C) 'benevolent' means well-meaning and kindly.",
        chinese_explanation: "(D) '吝啬的' 意味着不愿花钱或使用资源；吝啬或节俭的。" +
            "<br><br>" +
            "(A) '轻浮的' 意味着没有任何严肃目的或价值。" +
            "<br><br>" +
            "(B) '奢华的' 意味着奢侈豪华的。" +
            "<br><br>" +
            "(C) '仁慈的' 意味着善意的和亲切的。"
