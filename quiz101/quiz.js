...
var questions = [
    ...
    correctAnswer: "B",
    explanation: "(B) 'badgered' means repeatedly ask (someone) to do something; pester. Figuratively, it can mean feeling pressured or harassed by constant demands." +
        "<br><br>" +
    ...
    chinese_explanation: "(B) '骚扰'一词意味着反复要求（某人）做某事；纠缠。比喻地，它可以表示因不断的要求而感到压力或困扰。" +
        "<br><br>" +
    ...
    {
        id: 4,
        question: "The judge ordered the clerk to __________ the defendant’s record after the case was dismissed.",
        chinese_question: "案件被驳回后，法官命令书记员 __________ 被告的记录。",
        answers: [
    ...
    {
        id: 8,
        question: "The spy managed to __________ the secret documents in a safe place until he could deliver them.",
        chinese_question: "间谍设法将机密文件 __________ 在一个安全的地方，直到他能将它们交付。",
        answers: [
            ...
            { option: "D", answer: "consume", chinese_answer: "消耗", chinese_romanization: "xiāohào" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'secrete' means to conceal or hide." +
            "<br><br>" +
            "(B) 'disclose' means to make a secret known." +
            "<br><br>" +
            "(C) 'reveal' means to make known to others." +
            "<br><br>" +
            "(D) 'consume' means to eat, drink, or use up.",
