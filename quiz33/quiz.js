...
var questions = [
    ...
    {
        id: 6,
    question: "The audience's __________ applause made it clear that the performance had not met their expectations, and they were visibly disappointed.",
    chinese_question: "观众 __________ 的掌声表明演出没有达到他们的期望，他们显然很失望。",
    answers: [
        ...
        { option: "C", answer: "uproarious", chinese_answer: "哄然的", chinese_romanization: "hōngrán de" },
        { option: "D", answer: "tepid", chinese_answer: "冷淡的", chinese_romanization: "lěndàn de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'tepid' means showing little or no enthusiasm or interest." +
        "<br><br>" +
        "(A) 'enthusiastic' means showing a lot of excitement, enjoyment, or interest, like when you really like something and show it clearly." +
        "<br><br>" +
        "(B) 'boisterous' means being very noisy, energetic, and cheerful, like a loud and happy crowd." +
        "<br><br>" +
        "(C) 'uproarious' means causing or involving loud laughter and noise, like something very funny or exciting.",
    chinese_explanation: "(D) '冷淡的' 意味着表现出很少或没有热情或兴趣。" +
        "<br><br>" +
        "(A) '热情的' 意味着表现出很多的兴奋、享受或兴趣，就像当你真的喜欢某件事并明确表现出来时。" +
        "<br><br>" +
        "(B) '喧闹的' 意味着非常吵闹、充满活力和欢快，就像一个吵闹又快乐的人群。" +
        "<br><br>" +
        "(C) '哄然的' 意味着引起或涉及大声笑声和噪音，就像非常有趣或激动的事情。"
    },
    {
        id: 7,
