...
var questions = [
    {
        ...
        answers: [
            ...
            { option: "C", answer: "depose", chinese_answer: "罢免", chinese_romanization: "bàmiǎn" },
            { option: "D", answer: "support", chinese_answer: "支持", chinese_romanization: "zhīchí" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'depose' means to remove from office suddenly and forcefully." +
            "<br><br>" +
            "(A) 'reward' means to give something to someone in recognition of their services, efforts, or achievements." +
            "<br><br>" +
            "(B) 'promote' means to support or actively encourage." +
            "<br><br>" +
            "(D) 'support' means to give assistance to.",
        chinese_explanation: "(C) '罢免' 意味着突然且强制地将其免职。" +
            "<br><br>" +
    ...
    answers: [
        { option: "A", answer: "survey", chinese_answer: "勘测", chinese_romanization: "kāncè" },
        { option: "B", answer: "traverse", chinese_answer: "穿越", chinese_romanization: "chuānyuè" },
        { option: "C", answer: "sketch", chinese_answer: "素描", chinese_romanization: "sùmiáo" },
        { option: "D", answer: "map", chinese_answer: "绘制地图", chinese_romanization: "huìzhì dìtú" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'traverse' means to travel across or through." +
        "<br><br>" +
        "(A) 'survey' means to examine and record the area and features of (an area of land) so as to construct a map, plan, or description." +
        "<br><br>" +
        "(C) 'sketch' means to make a rough drawing of." +
        "<br><br>" +
        "(D) 'map' means to make a map of an area.",
    chinese_explanation: "(B) '穿越' 意味着穿过或通过。" +
        "<br><br>" +
        "(A) '勘测' 意味着检查和记录（某个地区的）区域和特征，以便构建地图、计划或描述。" +
        "<br><br>" +
        "(C) '素描' 意味着粗略地画出来。" +
        "<br><br>" +
        "(D) '绘制地图' 意味着绘制某个区域的地图。"
    },
    {
        ...
        explanation: "(C) 'embellish' means to make a story more interesting by adding extra details that are often untrue." +
            ...
            "<br><br>" +
            "(B) 'ruin' means to destroy or spoil." +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "destroyed", chinese_answer: "毁坏", chinese_romanization: "huǐhuài" },
            { option: "B", answer: "neglected", chinese_answer: "忽视", chinese_romanization: "hūshì" },
            { option: "C", answer: "weakened", chinese_answer: "削弱", chinese_romanization: "xuēruò" },
            { option: "D", answer: "honed", chinese_answer: "磨炼", chinese_romanization: "móliàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'honed' means to refine or perfect something over a period of time." +
            "<br><br>" +
            "(A) 'destroyed' means to put an end to the existence of something by damaging or attacking it." +
            "<br><br>" +
            "(B) 'neglected' means to fail to care for or give attention to something." +
            "<br><br>" +
            "(C) 'weakened' means to make something less strong.",
        chinese_explanation: "(D) '磨炼' 意味着在一段时间内改进或完善某事。" +
            "<br><br>" +
            "(A) '毁坏' 意味着通过损坏或攻击使某物不存在。" +
            "<br><br>" +
            "(B) '忽视' 意味着未能照顾或给予某事物关注。" +
            "<br><br>" +
            "(C) '削弱' 意味着使某物不那么强壮。"
    },
    {
