...
var questions = [
    {
        id: 1,
        question: "In the final match, the chess grandmaster managed to __________ his opponent with a brilliant endgame strategy, thus securing the championship title.",
        chinese_question: "在最后一场比赛中，国际象棋大师用一个出色的残局策略 __________ 了他的对手，赢得了冠军头衔。",
        answers: [
            { option: "A", answer: "examine", chinese_answer: "检查", chinese_romanization: "jiǎnchá" },
            { option: "B", answer: "illuminate", chinese_answer: "照亮", chinese_romanization: "zhàoliàng" },
            { option: "C", answer: "translate", chinese_answer: "翻译", chinese_romanization: "fānyì" },
            { option: "D", answer: "vanquish", chinese答案: "击败", chinese_romanization: "jíbài" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'vanquish' means to defeat thoroughly." +
            "<br><br>" +
            "(A) 'examine' means to inspect or scrutinize carefully." +
            "<br><br>" +
            "(B) 'illuminate' means to light up or make clear." +
            "<br><br>" +
            "(C) 'translate' means to express the sense of words or text in another language.",
        chinese_explanation: "(D) '击败' 意味着彻底击败。" +
            "<br><br>" +
            "(A) '检查' 意味着仔细检查或审查。" +
            "<br><br>" +
            "(B) '照亮' 意味着点亮或弄清楚。" +
            "<br><br>" +
            "(C) '翻译' 意味着用另一种语言表达词语或文本的意义。"
    },
    {
        id: 2,
        ...
        answers: [
            { option: "A", answer: "streamline", chinese_answer: "精简", chinese_romanization: "jīngjiǎn" },
            ...
            { option: "D", answer: "ease", chinese_answer: "缓解", chinese_romanization: "huǎnjiě" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'complicate' means to make something more difficult or confusing." +
            "<br><br>" +
            "(A) 'streamline' means to make an organization or system more efficient and effective by employing faster or simpler working methods." +
            "<br><br>" +
            "(B) 'simplify' means to make something simpler or easier to do or understand." +
            "<br><br>" +
            "(D) 'ease' means to make something less serious or severe.",
        chinese_explanation: "(C) '复杂化' 意味着使某事更加困难或令人困惑。" +
            "<br><br>" +
            "(A) '精简' 意味着通过采用更快或更简单的工作方法使组织或系统更高效和有效。" +
            "<br><br>" +
