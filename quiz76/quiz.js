...
var questions = [
    ...
    answers: [
        ...
        { option: "C", answer: "orderliness", chinese_answer: "有序", chinese_romanization: "yǒuxù" },
    ...
    explanation: "(A) 'mayhem' means a state of chaos and disorder." +
        "<br><br>" +
        "(B) 'organization' means the act of arranging or being arranged." +
        "<br><br>" +
        "(C) 'orderliness' means the quality of being neat and orderly." +
        "<br><br>" +
        "(D) 'serenity' means the state of being calm and peaceful.",
    ...
    {
        id: 4,
    question: "The novel describes the character's descent into __________, highlighting his immoral behavior and reckless lifestyle.",
    chinese_question: "小说描述了角色陷入 __________ 的过程，突显了他的不道德行为和放荡的生活方式。",
    answers: [
