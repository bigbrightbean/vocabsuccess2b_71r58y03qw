...
var questions = [
    ...
    {
        id: 2,
        question: "Finding a balance between work and life is the __________ many people seek, as it leads to greater overall well-being and happiness.",
        chinese_question: "找到工作与生活之间的平衡是许多人寻找的 __________，因为它能带来更大的整体幸福感。",
        answers: [
            { option: "A", answer: "dilemma", chinese_answer: "困境", chinese_romanization: "kùnjìng" },
            { option: "B", answer: "issue", chinese_answer: "问题", chinese_romanization: "wèntí" },
        ...
        explanation: "(D) 'solution' means a means of solving a problem or dealing with a difficult situation." +
            ...
            "<br><br>" +
            "(B) 'issue' means an important topic or problem for debate or discussion." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '解决方案' 意味着解决问题或处理困难情况的方法。" +
            ...
            "<br><br>" +
            "(B) '问题' 意味着需要讨论或讨论的重要话题或问题。" +
            "<br><br>" +
            "(C) '挑战' 意味着测试某人能力的任务或情况。"
    },
    {
        id: 3,
    ...
    {
        id: 5,
    question: "There was a clear __________ among the community members to build a new park in the neighborhood, with everyone agreeing on its benefits and importance.",
    chinese_question: "社区成员就建造一个新公园达成了明确的 __________，每个人都同意其益处和重要性。",
    answers: [
    ...
    {
        id: 10,
        question: "The policy changes were implemented without considering the __________, which included job losses, decreased employee morale, and higher operational costs.",
        chinese_question: "在没有考虑 __________ 的情况下实施了政策变更，这些后果包括失业、员工士气下降和更高的运营成本。",
        answers: [
            { option: "A", answer: "distortions", chinese_answer: "扭曲", chinese_romanization: "niǔqū" },
            { option: "B", answer: "elaborations", chinese_answer: "详细阐述", chinese_romanization: "xiángxì chǎnshù" },
            { option: "C", answer: "revelations", chinese_answer: "揭示", chinese_romanization: "jiēshì" },
            { option: "D", answer: "ramifications", chinese_answer: "后果", chinese_romanization: "hòuguǒ" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'ramifications' means a consequence of an action or event, especially when complex or unwelcome." +
            "<br><br>" +
            "(A) 'distortions' means the action of giving a misleading account or impression." +
            "<br><br>" +
            "(B) 'elaborations' means the process of developing or presenting a theory, policy, or system in further detail." +
            "<br><br>" +
            "(C) 'revelations' means a surprising and previously unknown fact that has been disclosed to others.",
        chinese_explanation: "(D) '后果' 意味着某个行动或事件的结果，尤其是复杂或不受欢迎的结果。" +
            "<br><br>" +
            "(A) '扭曲' 意味着给出误导性描述或印象的行为。" +
            "<br><br>" +
            "(B) '详细阐述' 意味着进一步详细制定或呈现理论、政策或系统的过程。" +
            "<br><br>" +
            "(C) '揭示' 意味着令人惊讶且先前未知的事实已向他人披露。"
    }
];
