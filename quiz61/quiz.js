...
var questions = [
    {
        id: 1,
    question: "The birth __________ in the country has been steadily declining over the past decade, which meant that fewer babies were being born each year.",
    chinese_question: "过去十年该国的出生 __________ 稳步下降，这意味着每年出生的婴儿越来越少。",
    answers: [
    ...
    {
        id: 2,
        question: "Even when his colleague slipped and fell, his __________ was evident as he barely glanced over and continued with his work without offering help.",
        chinese_question: "即使当他的同事滑倒时，他的 __________ 也很明显，他只是略微瞥了一眼，然后继续工作，没有提供帮助。",
        answers: [
            ...
            { option: "C", answer: "empathy", chinese_answer: "共情", chinese_romanization: "gòngqíng" },
        ...
        chinese_explanation: "(D) '冷漠' 意味着缺乏兴趣、热情或关心。" +
            "<br><br>" +
            "(A) '同情' 意味着对他人痛苦或不幸的同情怜悯和关心。" +
            "<br><br>" +
            "(B) '关心' 意味着某人感兴趣或重要的事情。" +
            "<br><br>" +
            "(C) '共情' 意味着理解和分享他人感受的能力。"
    },
    {
        id: 3,
    ...
    {
        id: 4,
    question: "His exaggerated stories often resulted in a collective __________ from his listeners, especially when he added ridiculous details and improbable events like wrestling an alligator or outrunning a cheetah.",
    chinese_question: "他夸张的故事常常引起听众们集体的 __________，特别是当他加入荒谬的细节和不可能的事件时，如与鳄鱼摔跤或跑赢猎豹。",
    answers: [
        ...
        { option: "C", answer: "whimper", chinese_answer: "呜咽", chinese_romanization: "wūyè" },
        { option: "D", answer: "gargle", chinese_answer: "漱口", chinese_romanization: "shùkǒu" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'guffaw' used figuratively means a loud and boisterous laugh." +
        ...
        "<br><br>" +
        "(C) 'whimper' means to make a series of low, feeble sounds expressive of fear, pain, or discontent." +
        "<br><br>" +
        "(D) 'gargle' means to wash one's mouth and throat with a liquid that is kept in motion by exhaling through it.",
    chinese_explanation: "(B) '哄笑' 在比喻意义上指响亮而欢闹的笑声。" +
        "<br><br>" +
        "(A) '低语' 意味着用气息轻声说话，尤其是为了保密。" +
        "<br><br>" +
        "(C) '呜咽' 意味着发出一系列低而微弱的声音，表达恐惧、疼痛或不满。" +
        "<br><br>" +
        "(D) '漱口' 意味着用液体洗漱口腔和喉咙，通过呼气使其运动。"
    },
    {
        id: 5,
