...
var questions = [
    ...
    {
        id: 2,
    question: "She received a __________ opportunity to study abroad on a full scholarship, an opportunity that her classmates could only dream of.",
    chinese_question: "她获得了一个 __________ 的机会，可以全额奖学金出国留学，这个机会是她的同学们梦寐以求的。",
    answers: [
    ...
    {
        id: 6,
    question: "His __________ explanation for the sudden change in plans, such as outlining the benefits and addressing potential concerns, convinced everyone that it was the best course of action.",
    chinese_question: "他对计划突然改变的 __________ 解释，例如列出好处和解决潜在问题，让所有人相信这是最好的行动方案。",
    answers: [
