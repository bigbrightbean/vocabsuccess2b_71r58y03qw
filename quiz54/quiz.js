...
var questions = [
    ...
    {
        id: 5,
        question: "His love letter, though written in __________ that was straightforward and lacking in poetic structure, conveyed his feelings with deep emotion and clarity.",
        chinese_question: "虽然他的情书是用 __________ 写的，结构简单且缺乏诗意，但他清晰地传达了深厚的感情。",
        answers: [
    ...
    {
        id: 10,
    question: "The landmark court decision served as a __________ for all subsequent cases involving digital privacy, setting a standard and guiding future judgments if similar issues arise.",
    chinese_question: "具有里程碑意义的法院判决成为所有涉及数字隐私的后续案件的 __________，设立了标准并在类似问题出现时指导未来的判决。",
    answers: [
