...
var questions = [
    ...
    {
        id: 2,
    question: "The __________ shown by the community towards the environmental issues was alarming.",
    chinese_question: "社区对环境问题表现出的 __________ 令人担忧。",
    answers: [
    ...
    {
        id: 5,
    question: "The __________ of the internet has revolutionized how we communicate and access information.",
    chinese_question: "互联网的 __________ 彻底改变了我们的交流和获取信息的方式。",
    answers: [
        ...
        { option: "C", answer: "disappearance", chinese_answer: "消失", chinese_romanization: "xiāoshī" },
        { option: "D", answer: "conclusion", chinese_answer: "结束", chinese_romanization: "jiéshù" }
    ],
    correctAnswer: "A",
    explanation: "(A) 'advent' means the arrival of a notable person, thing, or event." +
        ...
        "<br><br>" +
        "(C) 'disappearance' means the action or process of disappearing." +
        "<br><br>" +
    ...
    {
        id: 6,
    question: "The __________ of artificial intelligence in various industries is reshaping job markets and economies.",
    chinese_question: "人工智能在各个行业的 __________ 正在重塑就业市场和经济。",
    answers: [
        { option: "A", answer: "advent", chinese_answer: "到来", chinese_romanization: "dàolái" },
