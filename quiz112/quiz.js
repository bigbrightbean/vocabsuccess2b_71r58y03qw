...
var questions = [
    ...
    {
        id: 2,
        question: "The new video game __________ a whole community of dedicated players and fan clubs.",
        chinese_question: "这款新电子游戏 __________ 了一个由忠实玩家和粉丝俱乐部组成的社区。",
        answers: [
            { option: "A", answer: "limited", chinese_answer: "限制", chinese_romanization: "xiànzhì" },
            { option: "B", answer: "blocked", chinese_answer: "阻塞", chinese_romanization: "zǔsè" },
            { option: "C", answer: "spawned", chinese_answer: "产生", chinese_romanization: "chǎnshēng" },
            { option: "D", answer: "hindered", chinese_answer: "阻碍", chinese_romanization: "zǔ'ài" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'spawned' means to generate or bring forth." +
            "<br><br>" +
            "(A) 'limited' means to restrict the amount, extent, or range of." +
            "<br><br>" +
            "(B) 'blocked' means to make the movement or flow in (a passage, pipe, road, etc.) difficult or impossible." +
            "<br><br>" +
            "(D) 'hindered' means to create difficulties for someone or something, resulting in delay or obstruction.",
        chinese_explanation: "(C) '产生' 意味着生成或引发。" +
            "<br><br>" +
            "(A) '限制' 意味着限制数量、程度或范围。" +
            "<br><br>" +
            "(B) '阻塞' 意味着使通道、管道、道路等的流动变得困难或不可能。" +
            "<br><br>" +
            "(D) '阻碍' 意味着为某人或某物制造困难，导致延误或阻碍。"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "enjoyed", chinese_answer: "享受", chinese_romanization: "xiǎngshòu" },
            { option: "C", answer: "decried", chinese_answer: "谴责", chinese_romanization: "qiǎnzé" },
            { option: "D", answer: "praised", chinese_answer: "表扬", chinese_romanization: "biǎoyáng" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'decried' means to publicly denounce or criticize." +
            "<br><br>" +
            "(A) 'applauded' means to show strong approval of a person or action, especially by clapping hands." +
            "<br><br>" +
            "(B) 'enjoyed' means to take delight or pleasure in an activity or occasion." +
            "<br><br>" +
            "(D) 'praised' means to express warm approval or admiration of.",
        chinese_explanation: "(C) '谴责'一词意味着公开谴责或批评。" +
            "<br><br>" +
            "(A) '赞扬' 意味着通过鼓掌对某人或某行动表示强烈赞同。" +
            "<br><br>" +
            "(B) '享受' 意味着从一项活动或场合中获得乐趣或享受。" +
            "<br><br>" +
            "(D) '表扬' 意味着表达温暖的赞同或钦佩。"
    },
    {
    ...
    {
        id: 8,
    question: "The community leaders __________ with the city council to improve the local infrastructure by requesting additional funding and proposing new projects.",
    chinese_question: "社区领导人通过请求额外资金和提出新项目来 __________ 市议会改善当地基础设施。",
    answers: [
    ...
    {
        id: 10,
    question: "You can __________ on me to keep your secret as your friend because I value our relationship.",
    chinese_question: "你可以 __________ 我保守你的秘密，因为作为你的朋友，我重视我们的关系。",
    answers: [
