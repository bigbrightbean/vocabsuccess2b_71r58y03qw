...
var questions = [
    ...
    {
        id: 8,
        question: "The __________ of the mysterious island was so strong that it drew explorers from all around the world to uncover its secrets and witness its beauty.",
        chinese_question: "那座神秘岛屿的 __________ 如此强烈，以至于吸引了来自世界各地的探险家前来揭示其秘密并目睹其美丽。",
        answers: [
            { option: "A", answer: "danger", chinese_answer: "危险", chinese_romanization: "wēixiǎn" },
            { option: "B", answer: "size", chinese_answer: "大小", chinese_romanization: "dàxiǎo" },
            { option: "C", answer: "location", chinese_answer: "位置", chinese_romanization: "wèizhì" },
            { option: "D", answer: "allure", chinese_answer: "诱惑力", chinese_romanization: "yòuhuòlì" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'allure' means the quality of being powerfully and mysteriously attractive or fascinating." +
            "<br><br>" +
            "(A) 'danger' means the possibility of suffering harm or injury." +
            "<br><br>" +
            "(B) 'size' means the relative extent of something; a thing's overall dimensions or magnitude." +
            "<br><br>" +
            "(C) 'location' means a particular place or position.",
        chinese_explanation: "(D) '诱惑力' 意味着神秘地具有吸引力或令人着迷的品质。" +
            "<br><br>" +
            "(A) '危险' 意味着可能遭受伤害或损伤的可能性。" +
            "<br><br>" +
            "(B) '大小' 意味着某物的相对范围；事物的整体尺寸或规模。" +
            "<br><br>" +
            "(C) '位置' 意味着特定的地方或位置。"
    },
    {
        id: 9,
    question: "As they walked onto the vast floor surrounded by rising seats, the athletes entered the __________ to the cheers of thousands of fans.",
    chinese_question: "当他们走上被高高耸立的座位包围的广阔场地，运动员们进入 __________，成千上万名粉丝为他们欢呼。",
    answers: [
        { option: "A", answer: "paradox", chinese_answer: "悖论", chinese_romanization: "bèilùn" },
    ...
    explanation: "(B) 'arena' means a level area surrounded by seats for spectators, in which sports, entertainments, and other public events are held." +
        "<br><br>" +
        "(A) 'paradox' means a statement or proposition that, despite sound reasoning, leads to a conclusion that seems senseless or self-contradictory." +
        "<br><br>" +
        "(C) 'room' means a part or division of a building enclosed by walls, floor, and ceiling." +
        "<br><br>" +
        "(D) 'dilemma' means a situation in which a difficult choice has to be made between two or more alternatives, especially ones that are equally undesirable.",
    chinese_explanation: "(B) '竞技场' 意味着一个四周有座位的平坦区域，观众在其中观看体育比赛、娱乐活动和其他公共活动。" +
        ...
        "<br><br>" +
        "(D) '困境' 意味着一种必须在两个或多个同样不理想的选择之间做出艰难选择的情况。"
    },
    {
        id: 10,
    question: "The detective considered the elusive thief his __________, as he always managed to escape capture and taunt him with clues.",
    chinese_question: "侦探认为这个难以捉摸的小偷是他的 __________，因为他总是能逃脱抓捕并用线索嘲弄他。",
    answers: [
