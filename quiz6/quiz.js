...
var questions = [
    {
        id: 1,
    question: "Everyone in the office loved his unique __________ of always wearing mismatched socks and humming while he worked.",
    chinese_question: "办公室里的每个人都喜欢他独特的 __________，比如总是穿不配对的袜子和工作时哼歌。",
    answers: [
    ...
    {
        id: 9,
    question: "The new policy received widespread __________ from the employees, who appreciated the extra vacation days and flexible working hours that were previously unavailable.",
    chinese_question: "新政策获得了员工们的广泛 __________，他们很感激以前没有的额外假期和灵活的工作时间。",
    answers: [
    ...
    explanation: "(D) 'approbation' means approval or praise." +
        ...
        "<br><br>" +
        "(C) 'condemnation' means the expression of very strong disapproval.",
    chinese_explanation: "(D) '赞许' 意味着批准或赞扬。" +
        "<br><br>" +
        "(A) '批评' 意味着基于感知的错误或错误表达不赞成。" +
        "<br><br>" +
        "(B) '不赞成' 意味着持有或表达不赞成的意见。" +
        "<br><br>" +
        "(C) '谴责' 意味着非常强烈的不赞成的表达。"
    },
    {
