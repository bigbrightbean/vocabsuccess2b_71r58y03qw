...
var questions = [
    ...
    {
        id: 5,
    question: "Improving __________ in patients recovering from surgery is a key focus for physical therapists, since regaining the ability to move independently is crucial for their overall recovery.",
    chinese_question: "改善手术康复患者的 __________ 是物理治疗师的一个重要关注点，因为恢复独立行动的能力对他们的整体康复至关重要。",
    answers: [
