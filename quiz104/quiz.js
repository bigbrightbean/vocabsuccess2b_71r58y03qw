...
var questions = [
    {
        id: 1,
        question: "The repeated exposure to violence in media can __________ aggressive behaviours in some individuals by normalizing such actions and desensitizing viewers to real-world violence.",
        chinese_question: "媒体中反复出现的暴力内容会通过将这些行为正常化并使观众对现实世界中的暴力麻木， __________ 某些人的攻击行为。",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "circumvent", chinese_answer: "绕过", chinese_romanization: "ràoguò" },
            { option: "D", answer: "reinforce", chinese_answer: "加强", chinese_romanization: "jiāqiáng" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'circumvent' means to find a way around (an obstacle)." +
            "<br><br>" +
            ...
            "<br><br>" +
            "(D) 'reinforce' means to strengthen or support, especially with additional personnel or material.",
        chinese_explanation: "(C) '绕过' 意味着找到绕过（障碍物）的办法。" +
            "<br><br>" +
            "(A) '增强' 意味着加强、增加或进一步改善质量、价值或程度。" +
            "<br><br>" +
            "(B) '跟随' 意味着在（前面行进的人或事物）之后走或来；移动或旅行在后面。" +
            "<br><br>" +
            "(D) '加强' 意味着加强或支持，尤其是增加人员或材料。"
    },
    {
        id: 3,
        question: "The aspiring artist __________ the fame and recognition of established painters, as they seemed to effortlessly command respect and admiration.",
        chinese_question: "这位有抱负的艺术家 __________ 成名画家的声誉和认可，因为他们似乎轻松地赢得了尊重和钦佩。",
        answers: [
    ...
    {
        id: 7,
        question: "To maintain order and discipline, the principal refused to __________ the students' disruptive behavior, insisting on strict consequences for their actions.",
        chinese_question: "为了保持秩序和纪律，校长拒绝 __________ 学生们的捣乱行为，坚持对他们的行为采取严格的惩罚措施。",
        answers: [
            { option: "A", answer: "obfuscate", chinese_answer: "使模糊", chinese_romanization: "shǐ móhū" },
            ...
            { option: "D", answer: "condone", chinese_answer: "纵容", chinese_romanization: "zòngróng" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'condone' means to accept or allow behavior that is considered morally wrong or offensive to continue." +
            "<br><br>" +
            "(A) 'obfuscate' means to render obscure, unclear, or unintelligible." +
            "<br><br>" +
            "(B) 'procrastinate' means to delay or postpone action; put off doing something." +
            "<br><br>" +
            "(C) 'fabricate' means to invent or concoct something, typically with deceitful intent.",
        chinese_explanation: "(D) '纵容' 意味着接受或允许被认为在道德上错误或令人反感的行为继续。" +
            "<br><br>" +
            "(A) '使模糊' 意味着使变得模糊、不清楚或难以理解。" +
            "<br><br>" +
            "(B) '拖延' 意味着延迟或推迟行动；推迟做某事。" +
            "<br><br>" +
            "(C) '编造' 意味着发明或捏造某事，通常带有欺骗意图。"
    },
    {
        id: 8,
    ...
    },
    {
        ...
        explanation: "(C) 'predict' means to say or estimate that a specified thing will happen in the future or will be a consequence of something." +
            ...
            "<br><br>" +
            "(B) 'misinterpret' means to interpret something wrongly." +
            "<br><br>" +
            "(D) 'complicate' means to make something more difficult or complex.",
