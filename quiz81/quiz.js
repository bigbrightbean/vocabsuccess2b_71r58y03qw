...
var questions = [
    ...
    {
        id: 3,
        question: "Despite having a lot of work to do, she decided to __________ at the beach, wandering aimlessly and enjoying the sunshine.",
        chinese_question: "尽管有很多工作要做，她还是决定在海滩上 __________，漫无目的地闲逛并享受阳光。",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "brandish", chinese_answer: "挥舞", chinese_romanization: "huīwǔ" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'brandish' means to wave or flourish something, especially a weapon, as a threat or in anger or excitement." +
            "<br><br>" +
            "(A) 'conceal' means to keep something secret." +
            "<br><br>" +
            "(B) 'destroy' means to put an end to the existence of something." +
            "<br><br>" +
            "(C) 'abandon' means to give up completely.",
        chinese_explanation: "(D) '挥舞' 意味着挥动或展示某物，尤其是武器，作为威胁或出于愤怒或兴奋。" +
            "<br><br>" +
            "(A) '隐藏' 意味着保密某事。" +
            "<br><br>" +
            "(B) '破坏' 意味着结束某物的存在。" +
