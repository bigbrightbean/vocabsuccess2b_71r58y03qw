...
var questions = [
    ...
    {
        id: 7,
    question: "The quality control team found a small __________ on the batch of smartphones, such as tiny scratches on the screens, before they were shipped out.",
    chinese_question: "质量控制团队在发货前发现了一批智能手机上的小 __________，例如屏幕上的细小划痕。",
    answers: [
        { option: "A", answer: "enhancement", chinese_answer: "增强", chinese_romanization: "zēngqiáng" },
        { option: "B", answer: "improvement", chinese_answer: "改进", chinese_romanization: "gǎijìn" },
        { option: "C", answer: "perfection", chinese_answer: "完美", chinese_romanization: "wánměi" },
        { option: "D", answer: "blemish", chinese_answer: "瑕疵", chinese_romanization: "xiácī" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'blemish' means a small mark or flaw that spoils the appearance of something." +
        "<br><br>" +
        "(A) 'enhancement' means an improvement that makes something more valuable or effective." +
        "<br><br>" +
        "(B) 'improvement' means the process of making something better." +
        "<br><br>" +
        "(C) 'perfection' means the state of being perfect or without flaws.",
    chinese_explanation: "(D) '瑕疵' 意味着破坏某物外观的小痕迹或缺陷。" +
        "<br><br>" +
        "(A) '增强' 意味着提高某物价值或效力的改进。" +
        "<br><br>" +
        "(B) '改进' 意味着使某物变得更好的过程。" +
        "<br><br>" +
        "(C) '完美' 意味着完美或没有缺陷的状态。"
