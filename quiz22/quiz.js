...
var questions = [
    ...
    {
        id: 9,
    question: "The doctor’s unexpected diagnosis completely __________ the patient, who didn’t know what to say.",
    chinese_question: "医生意外的诊断让病人完全 __________ ，他不知道该说什么。",
    answers: [
        { option: "A", answer: "comforted", chinese_answer: "安慰", chinese_romanization: "ānwèi" },
        { option: "B", answer: "enlightened", chinese_answer: "启发", chinese_romanization: "qǐfā" },
        { option: "C", answer: "nonplused", chinese_answer: "使困惑", chinese_romanization: "shǐ kùnhuò" },
        { option: "D", answer: "reassured", chinese_answer: "使放心", chinese_romanization: "shǐ fàngxīn" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'nonplused' means to surprise and confuse someone so much that they are unsure how to react." +
        "<br><br>" +
        "(A) 'comforted' means to ease someone's grief or distress." +
        "<br><br>" +
        "(B) 'enlightened' means to give someone greater knowledge and understanding." +
        "<br><br>" +
        "(D) 'reassured' means to say or do something to remove the doubts and fears of someone.",
    chinese_explanation: "(C) '使困惑' 意味着让某人感到惊讶和困惑，以至于他们不确定如何反应。" +
        "<br><br>" +
        "(A) '安慰' 意味着减轻某人的悲伤或痛苦。" +
        "<br><br>" +
        "(B) '启发' 意味着给予某人更多的知识和理解。" +
        "<br><br>" +
        "(D) '使放心' 意味着说或做某事以消除某人的疑虑和恐惧。"
    },
    {
        id: 10,
