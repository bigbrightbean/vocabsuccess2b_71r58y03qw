...
var questions = [
    {
        id: 1,
        question: "The __________ honesty of his feedback helped her improve her work significantly.",
        chinese_question: "他 __________ 的诚实反馈帮助她显著地改进了她的工作。",
        answers: [
    ...
    {
        id: 7,
        question: "Her __________ was apparent when she effortlessly answered all the complex questions.",
        chinese_question: "她的__________在她轻松回答所有复杂问题时显而易见。",
        answers: [
            { option: "A", answer: "erudition", chinese_answer: "博学", chinese_romanization: "bóxué" },
            { option: "B", answer: "confusion", chinese_answer: "困惑", chinese_romanization: "kùnhuò" },
            { option: "C", answer: "laziness", chinese_answer: "懒惰", chinese_romanization: "lǎnduò" },
            { option: "D", answer: "timidity", chinese_answer: "胆怯", chinese_romanization: "dǎnqiè" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'erudition' means having or showing great knowledge or learning." +
            "<br><br>" +
            "(B) 'confusion' means lack of understanding; uncertainty." +
            "<br><br>" +
            "(C) 'laziness' means the quality of being unwilling to work or use energy." +
            "<br><br>" +
            "(D) 'timidity' means lack of courage or confidence.",
        chinese_explanation: "(A) '博学'一词意味着具有或表现出丰富的知识或学习。" +
            "<br><br>" +
            "(B) '困惑' 意味着缺乏理解；不确定。" +
            "<br><br>" +
            "(C) '懒惰' 意味着不愿工作或使用能量的品质。" +
            "<br><br>" +
            "(D) '胆怯' 意味着缺乏勇气或信心。"
    },
    {
        id: 8,
        question: "The brand name has become __________ with quality and excellence over the years.",
        chinese_question: "这个品牌名称多年来已成为 __________ 质量和卓越的代名词。",
        answers: [
            { option: "A", answer: "different", chinese_answer: "不同的", chinese_romanization: "bùtóng de" },
            { option: "B", answer: "unrelated", chinese_answer: "无关的", chinese_romanization: "wúguān de" },
            { option: "C", answer: "synonymous", chinese_answer: "同义的", chinese_romanization: "tóngyì de" },
            { option: "D", answer: "opposite", chinese_answer: "相反的", chinese_romanization: "xiāngfǎn de" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'synonymous' means closely associated with or suggestive of something." +
            "<br><br>" +
            "(A) 'different' means not the same as another or each other." +
            "<br><br>" +
            "(B) 'unrelated' means not related or linked." +
            "<br><br>" +
            "(D) 'opposite' means completely different; contrary.",
        chinese_explanation: "(C) '同义的' 意味着与某物紧密相关或暗示某物的。" +
            "<br><br>" +
            "(A) '不同的' 意味着与另一物或彼此不同的。" +
            "<br><br>" +
            "(B) '无关的' 意味着没有关系或联系的。" +
