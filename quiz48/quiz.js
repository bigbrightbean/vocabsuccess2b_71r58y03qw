...
var questions = [
    ...
    {
        id: 6,
    question: "The artist’s painting was a __________ of vibrant hues and intricate patterns.",
    chinese_question: "艺术家的画作是一幅充满鲜艳色彩和复杂图案的 __________。",
    answers: [
        { option: "A", answer: "canvas", chinese_answer: "画布", chinese_romanization: "huàbù" },
        { option: "B", answer: "kaleidoscope", chinese_answer: "万花筒", chinese_romanization: "wànhuātǒng" },
        { option: "C", answer: "portrait", chinese_answer: "肖像", chinese_romanization: "xiàoxiàng" },
    ...
    explanation: "(B) 'kaleidoscope' means a constantly changing pattern or sequence of elements." +
        "<br><br>" +
        "(A) 'canvas' means a piece of cloth on which an artist paints." +
        "<br><br>" +
        "(C) 'portrait' means a painting, drawing, photograph, or engraving of a person, especially one depicting only the face or head and shoulders." +
        "<br><br>" +
    ...
    chinese_explanation: "(B) '万花筒' 一词意味着不断变化的元素或序列的图案。" +
        ...
        "(A) '画布' 意味着艺术家作画的一块布。" +
        "<br><br>" +
        "(C) '肖像' 意味着描绘一个人的绘画、素描、照片或雕刻，尤其是只描绘面部或头部和肩部的。" +
        "<br><br>" +
        "(D) '风景画' 意味着表现自然内陆风景的画作。"
    },
    {
        id: 7,
    question: "His __________ that everyone admired his work was shattered when he received negative feedback.",
    chinese_question: "他认为每个人都钦佩他的工作，这是他的 __________，在收到负面反馈时被打破了。",
    answers: [
        ...
        { option: "D", answer: "belief", chinese_answer: "信念", chinese_romanization: "xìnniàn" }
    ],
    correctAnswer: "B",
