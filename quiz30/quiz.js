...
var questions = [
    ...
    {
        id: 2,
        question: "Achieving world peace is the __________ goal of the organization.",
        chinese_question: "实现世界和平是该组织的__________目标。",
        answers: [
    ...
    {
        id: 10,
    question: "For __________ results, it is important to follow the instructions precisely.",
    chinese_question: "为了达到 __________ 的结果，准确遵循指示是很重要的。",
    answers: [
