...
var questions = [
    ...
    answers: [
        ...
        { option: "C", answer: "approach", chinese_answer: "方法", chinese_romanization: "fāngfǎ" },
    ...
    {
        id: 7,
    question: "He approached the problem with the thoroughness and curiosity of a __________.",
    chinese_question: "他以学者的细致和好奇心处理问题。",
    answers: [
    ...
    {
        id: 9,
    question: "He was in a __________ over whether to attend his best friend's wedding or his sister's graduation ceremony, both happening on the same day.",
    chinese_question: "他陷入了 __________，不知道该参加他最好朋友的婚礼还是他妹妹的毕业典礼，这两个活动都在同一天举行。",
    answers: [
        ...
        { option: "D", answer: "decision", chinese_answer: "决定", chinese_romanization: "juédìng" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'quandary' means a state of perplexity or uncertainty over what to do in a difficult situation." +
        ...
        "<br><br>" +
        "(D) 'decision' means a conclusion or resolution reached after consideration.",
