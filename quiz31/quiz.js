...
var questions = [
    {
        id: 1,
    question: "Despite his young age, his __________ in classical music was astonishing, as he could discuss composers and pieces in depth.",
    chinese_question: "尽管他年纪轻轻，他在古典音乐方面的 __________ 令人惊讶，因为他能够深入讨论作曲家和作品。",
    answers: [
        { option: "A", answer: "erudition", chinese_answer: "博学", chinese_romanization: "bóxué" },
        { option: "B", answer: "superficiality", chinese_answer: "浅薄", chinese_romanization: "qiǎnbó" },
    ...
    correctAnswer: "A",
    explanation: "(A) 'erudition' means the quality of having or showing great knowledge or learning; scholarship." +
        "<br><br>" +
        "(B) 'superficiality' means lack of thoroughness, depth of character, or serious thought." +
        "<br><br>" +
        "(C) 'indifference' means lack of interest, concern, or sympathy." +
        "<br><br>" +
        "(D) 'ignorance' means lack of knowledge or information.",
    chinese_explanation: "(A) '博学' 意味着具有或显示出渊博知识或学问的质量；学术。" +
        "<br><br>" +
        "(B) '浅薄' 意味着缺乏深思熟虑、性格深度或认真思考。" +
        "<br><br>" +
        "(C) '漠不关心' 意味着缺乏兴趣、关注或同情。" +
        "<br><br>" +
        "(D) '无知' 意味着缺乏知识或信息。"
    },
    {
