...
var questions = [
    ...
    {
        id: 3,
    question: "The salesman would often __________ potential customers in the mall by approaching them boldly and starting conversations, in hopes of selling his products.",
    chinese_question: "这名推销员经常在商场里通过大胆接近并与潜在顾客交谈来 __________ 他们，试图推销他的产品。",
    answers: [
    ...
    {
        id: 5,
    question: "In order to excel, athletes must __________ on their training regimes and not be distracted by other activities or personal issues.",
    chinese_question: "为了出类拔萃，运动员必须专注在他们的训练计划上，不被其他活动或个人问题分心。",
    answers: [
    ...
    {
        id: 6,
    question: "At the party, she would __________ her designer dress and expensive jewelry, making sure everyone noticed her wealth and status.",
    chinese_question: "在聚会上，她会 __________ 她的名牌连衣裙和昂贵的珠宝，确保每个人都注意到她的财富和地位。",
    answers: [
    ...
    correctAnswer: "D",
    explanation: "(D) 'flaunt' means to show off something, especially in order to provoke envy or admiration." +
        "<br><br>" +
        "(A) 'conceal' means to keep something hidden or secret." +
        "<br><br>" +
        "(B) 'suppress' means to prevent the development or expression of something." +
        "<br><br>" +
        "(C) 'hide' means to put or keep out of sight.",
    chinese_explanation: "(D) '炫耀' 意味着炫耀某物，特别是为了引起嫉妒或钦佩。" +
        "<br><br>" +
        "(A) '隐藏' 意味着保持某物隐藏或秘密。" +
        "<br><br>" +
        "(B) '压制' 意味着阻止某事的发展或表达。" +
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "obeyed", chinese_answer: "遵守", chinese_romanization: "zūnshǒu" },
            { option: "B", answer: "supported", chinese_answer: "支持", chinese_romanization: "zhīchí" },
            { option: "C", answer: "contravened", chinese_answer: "违反", chinese_romanization: "wéifǎn" },
            { option: "D", answer: "upheld", chinese_answer: "维护", chinese_romanization: "wéihù" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'contravened' means to violate or conflict with a law, rule, or agreement." +
            "<br><br>" +
            "(A) 'obeyed' means to act in accordance with a wish or command." +
            "<br><br>" +
            "(B) 'supported' means to give assistance to." +
            "<br><br>" +
            "(D) 'upheld' means to maintain or support in the face of possible opposition.",
        chinese_explanation: "(C) '违反'一词意味着违反或与法律、规则或协议相冲突。" +
            "<br><br>" +
            "(A) '遵守' 意味着按照愿望或命令行事。" +
            "<br><br>" +
            "(B) '支持' 意味着给予帮助。" +
            "<br><br>" +
            "(D) '维护' 意味着在可能的反对面前保持或支持。"
    },
    {
        id: 10,
