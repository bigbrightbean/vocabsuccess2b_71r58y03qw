...
var questions = [
    ...
    {
        id: 8,
        question: "The __________ of data entry, with its endless rows of numbers and repetitive keystrokes, made the job incredibly tedious for the employees.",
        chinese_question: "数据输入的 __________，无尽的数字和重复的敲击键，使得这项工作对员工来说非常枯燥。",
        answers: [
            ...
            { option: "C", answer: "diversity", chinese_answer: "多样化", chinese_romanization: "duōyànghuà" },
            { option: "D", answer: "monotony", chinese_answer: "单调", chinese_romanization: "dāndiào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'monotony' means lack of variety and interest; tedious repetition and routine." +
            "<br><br>" +
            "(A) 'excitement' means a feeling of great enthusiasm and eagerness." +
            "<br><br>" +
            "(B) 'variety' means the quality or state of being different or diverse; the absence of uniformity or monotony." +
            "<br><br>" +
            "(C) 'diversity' means a range of different things.",
        chinese_explanation: "(D) '单调' 意味着缺乏变化和兴趣；乏味的重复和例行公事。" +
            "<br><br>" +
            "(A) '兴奋' 意味着极大的热情和渴望的感觉。" +
            "<br><br>" +
            "(B) '多样性' 意味着不同或多样的质量或状态；缺乏一致性或单调。" +
            "<br><br>" +
            "(C) '多样化' 意味着一系列不同的事物。"
    },
    {
    ...
    {
        id: 10,
    question: "Their latest __________ was a daring trek across the desert with minimal supplies that required immense courage and endurance.",
    chinese_question: "他们最近的 __________ 是一次勇敢的沙漠跋涉，带着最少的补给，需要极大的勇气和耐力。",
    answers: [
        { option: "A", answer: "escapade", chinese_answer: "冒险行为", chinese_romanization: "màoxiǎn xíngwéi" },
        { option: "B", answer: "convention", chinese_answer: "惯例", chinese_romanization: "guànlì" },
    ...
    explanation: "(A) 'escapade' means an act or incident involving excitement, daring, or adventure." +
        "<br><br>" +
        "(B) 'convention' means a way in which something is usually done, especially within a particular area or activity." +
        "<br><br>" +
    ...
    chinese_explanation: "(A) '冒险行为' 一词意味着涉及兴奋、大胆或冒险的行为或事件。" +
        "<br><br>" +
        "(B) '惯例' 意味着某事通常在特定领域或活动中完成的方式。" +
        "<br><br>" +
        "(C) '单调' 意味着缺乏多样性和兴趣；乏味的重复和常规。" +
        "<br><br>" +
        "(D) '义务' 意味着一个人在道德上或法律上有约束力的行为或行动；责任或承诺。"
    }
];
