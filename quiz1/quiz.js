...
var questions = [
    {
        id: 1,
    question: "His __________ response to the client's questions left a negative impression and suggested he was not interested in helping.",
    chinese_question: "他对客户问题的 __________ 回答留下了负面印象，表明他不愿意提供帮助。",
    answers: [
        ...
        { option: "C", answer: "curt", chinese_answer: "简短而失礼的", chinese_romanization: "jiǎnduǎn ér shīlǐ de" },
        { option: "D", answer: "elaborate", chinese_answer: "详尽的", chinese_romanization: "xiángjìn de" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'curt' means rudely brief or abrupt in speech or manner." +
        "<br><br>" +
        ...
        "<br><br>" +
        "(D) 'elaborate' means involving many careful details or complex planning.",
    chinese_explanation: "(C) '简短而失礼的' 意味着言辞简短且无礼。" +
        "<br><br>" +
        "(A) '冗长的' 意味着使用或表达的词语比需要的多。" +
        "<br><br>" +
        "(B) '礼貌的' 意味着有或表现出对他人的尊重和体贴。" +
        "<br><br>" +
        "(D) '详尽的' 意味着包含许多细节或复杂的计划。"
    },
    {
        id: 2,
    ...
    {
        id: 5,
    question: "He felt __________ after receiving the award, because his hard work was finally recognized.",
    chinese_question: "他在领奖后感到__________，因为他的辛勤工作终于得到了认可。",
    answers: [
