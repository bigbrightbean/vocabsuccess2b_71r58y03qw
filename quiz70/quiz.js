...
var questions = [
    ...
    answers: [
        ...
        { option: "C", answer: "message", chinese_answer: "信息", chinese_romanization: "xìnxī" },
        { option: "D", answer: "alert", chinese_answer: "警报", chinese_romanization: "jǐngbào" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'cue' means a signal for someone to enter or begin their speech or action." +
        ...
        "<br><br>" +
        "(C) 'message' means a verbal, written, or recorded communication sent to or left for a recipient." +
        "<br><br>" +
        "(D) 'alert' means a warning of danger.",
    chinese_explanation: "(B) '提示' 一词意味着某人进入或开始讲话或行动的信号。" +
        "<br><br>" +
        "(A) '线索' 意味着用于侦查犯罪或解决谜团的一块证据或信息。" +
        "<br><br>" +
        "(C) '信息' 意味着传送给收件人的口头、书面或录音的通信。" +
        "<br><br>" +
        "(D) '警报' 意味着危险警告。"
    },
    {
    ...
    {
        id: 8,
    question: "The stock market saw a dramatic __________ after the unexpected economic news.",
    chinese_question: "在意外的经济新闻发布后，股市出现了剧烈的 __________ 。",
    answers: [
