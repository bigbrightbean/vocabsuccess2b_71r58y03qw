...
var questions = [
    ...
    {
        id: 4,
    question: "Her novel is set in a __________ context, blending fictional characters with real events from the past.",
    chinese_question: "她的小说设置在 __________ 背景下，将虚构人物与过去的真实事件融合在一起。",
    answers: [
        { option: "A", answer: "mythical", chinese_answer: "神话的", chinese_romanization: "shénhuà de" },
        ...
        { option: "D", answer: "imaginary", chinese_answer: "想象的", chinese_romanization: "xiǎngxiàng de" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'historical' means relating to the study or representation of past events." +
        "<br><br>" +
        "(A) 'mythical' means occurring in or characteristic of myths or folk tales." +
        "<br><br>" +
        "(B) 'futuristic' means having or involving very modern technology or design." +
        "<br><br>" +
        "(D) 'imaginary' means existing only in the imagination.",
    chinese_explanation: "(C) '历史的' 意味着与过去事件的研究或表现有关的。" +
        "<br><br>" +
        "(A) '神话的' 意味着发生在或具有神话或民间故事的特征的。" +
        "<br><br>" +
        "(B) '未来的' 意味着具有或涉及非常现代的技术或设计的。" +
        "<br><br>" +
        "(D) '想象的' 意味着仅存在于想象中的。"
    },
    {
