...
var questions = [
    ...
    {
        id: 6,
        question: "His nervous __________ before the presentation showed how anxious he was.",
        chinese_question: "他在演讲前的紧张 __________ 显示出他有多焦虑。",
        answers: [
            { option: "A", answer: "jabber", chinese_answer: "喋喋不休", chinese_romanization: "diédiébùxiū" },
            { option: "B", answer: "contemplation", chinese_answer: "沉思", chinese_romanization: "chénsī" },
            { option: "C", answer: "meditation", chinese_answer: "冥想", chinese_romanization: "míngxiǎng" },
            { option: "D", answer: "silence", chinese_answer: "沉默", chinese_romanization: "chénmò" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'jabber' figuratively means to talk rapidly and excitedly but with little sense." +
            "<br><br>" +
            "(B) 'contemplation' means the action of looking thoughtfully at something for a long time." +
            "<br><br>" +
            "(C) 'meditation' means the action or practice of meditating." +
            "<br><br>" +
            "(D) 'silence' means complete absence of sound.",
        chinese_explanation: "(A) '喋喋不休' 在此语境下比喻快速且兴奋地说话，但意义不大。" +
            "<br><br>" +
            "(B) '沉思' 意味着长时间深思地看着某物的行为。" +
            "<br><br>" +
            "(C) '冥想' 意味着冥想的行动或实践。" +
            "<br><br>" +
            "(D) '沉默' 意味着完全没有声音。"
