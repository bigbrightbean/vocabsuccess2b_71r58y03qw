...
var questions = [
    ...
    {
        id: 7,
        question: "Despite the __________ design of the building, it served its functional purpose well.",
        chinese_question: "尽管这座建筑的设计 __________，但它很好地发挥了功能作用。",
        answers: [
    ...
    {
        id: 8,
        question: "Despite the __________ security at the event, there were no major incidents.",
        chinese_question: "尽管活动的安保措施 __________，但并没有发生重大事件。",
        answers: [
            { option: "A", answer: "tight", chinese_answer: "紧密的", chinese_romanization: "jǐnmì de" },
            { option: "B", answer: "meticulous", chinese_answer: "细致的", chinese_romanization: "xìzhì de" },
            { option: "C", answer: "slack", chinese_answer: "松懈的", chinese_romanization: "sōngxiè de" },
        ...
        explanation: "(C) 'slack' means showing a lack of activity or diligence; negligent." +
            "<br><br>" +
            "(A) 'tight' means closely and firmly; secure." +
            "<br><br>" +
            "(B) 'meticulous' means showing great attention to detail; very careful and precise." +
            "<br><br>" +
            "(D) 'stringent' means strict, precise, and exacting.",
        chinese_explanation: "(C) '松懈的' 意味着表现出缺乏活动或勤奋；疏忽的。" +
            "<br><br>" +
            "(A) '紧密的' 意味着紧密和牢固；安全的。" +
            "<br><br>" +
            "(B) '细致的' 意味着非常注重细节的；非常小心和精确的。" +
            "<br><br>" +
            "(D) '严格的' 意味着严格、精确和要求高的。"
    },
    {
