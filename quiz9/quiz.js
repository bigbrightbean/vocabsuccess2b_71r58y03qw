...
var questions = [
    {
        id: 1,
        question: "The detective admired the thief's __________ tactics, which made him hard to catch.",
        chinese_question: "侦探钦佩小偷的 __________ 策略，使他难以被抓住。",
        answers: [
    ...
    {
        id: 5,
        question: "Her __________ led her to trust people too easily, often believing their promises without question.",
        chinese_question: "她的 __________ 使她过于轻易地信任他人，常常毫无疑问地相信他们的承诺。",
        answers: [
            { option: "A", answer: "naïveté", chinese_answer: "天真", chinese_romanization: "tiānzhēn" },
            { option: "B", answer: "wisdom", chinese_answer: "智慧", chinese_romanization: "zhìhuì" },
            { option: "C", answer: "skepticism", chinese_answer: "怀疑态度", chinese_romanization: "huáiyí tàidu" },
            { option: "D", answer: "shrewdness", chinese_answer: "精明", chinese_romanization: "jīngmíng" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'naïveté' means lack of experience, wisdom, or judgment." +
            "<br><br>" +
        ...
        chinese_explanation: "(A) '天真' 意味着缺乏经验、智慧或判断力。" +
            "<br><br>" +
            "(B) '智慧' 意味着具有经验、知识和良好判断力的品质。" +
            "<br><br>" +
            "(C) '怀疑态度' 意味着对某事的真实性持怀疑态度。" +
            "<br><br>" +
            "(D) '精明' 意味着具有或表现出敏锐的判断力。"
    },
    {
        id: 6,
