...
var questions = [
    ...
    {
        id: 2,
        question: "Hiding behind a __________ of politeness and a fake smile, he pretended to be supportive when in actual fact, he harbored deep resentment and hostility towards his coworkers, often undermining their efforts in subtle ways.",
        chinese_question: "隐藏在 __________ 的礼貌和虚假的微笑背后，他假装支持，但实际上，他对同事怀有深深的怨恨和敌意，经常以微妙的方式破坏他们的努力。",
        answers: [
            { option: "A", answer: "sincerity", chinese_answer: "真诚", chinese_romanization: "zhēnchéng" },
            { option: "B", answer: "genuineness", chinese_answer: "真实性", chinese_romanization: "zhēnshíxìng" },
        ...
        correctAnswer: "D",
        explanation: "(D) 'veneer' means an attractive appearance that covers or disguises someone's true nature or feelings." +
            "<br><br>" +
            "(A) 'sincerity' means being free from pretense or deceit." +
            "<br><br>" +
            "(B) 'genuineness' means being authentic or real." +
            "<br><br>" +
            "(C) 'honesty' means the quality of being truthful and sincere.",
        chinese_explanation: "(D) '外表' 意味着掩盖或掩饰某人真实本性或感情的吸引人外表。" +
            "<br><br>" +
            "(A) '真诚' 意味着没有伪装或欺骗。" +
            "<br><br>" +
            "(B) '真实性' 意味着真实或真实的特质。" +
