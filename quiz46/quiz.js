...
var questions = [
    {
        id: 1,
        question: "The CEO believed it was __________ to expand the business into international markets despite the risks, and that it would lead to significant growth.",
        chinese_question: "首席执行官认为，尽管存在风险，将业务扩展到国际市场是__________的，并且这将带来显著的增长。",
        answers: [
    ...
    {
        id: 6,
    question: "He was __________ by the technical jargon in the instruction manual and found it hard to follow the steps because of the confusing language.",
    chinese_question: "他被说明书中的技术术语弄得__________，因为语言混乱，发现很难跟上步骤。",
    answers: [
