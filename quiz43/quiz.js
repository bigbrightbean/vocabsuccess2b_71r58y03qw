...
var questions = [
    ...
    {
        id: 2,
        question: "The author's __________ prose style made the novel a rich and immersive reading experience.",
        chinese_question: "作者的 __________ 散文风格使这部小说成为一种丰富而沉浸的阅读体验。",
        answers: [
            ...
            { option: "C", answer: "rotund", chinese_answer: "华丽的", chinese_romanization: "huálì de" },
            { option: "D", answer: "plain", chinese_answer: "简单的", chinese_romanization: "jiǎndān de" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'rotund' means (in this context) full and rich in sound or style; elaborate and rounded." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '华丽的' 意味着（在这个上下文中）声音或风格上丰满和丰富的；精致和圆润的。" +
            "<br><br>" +
            "(A) '稀疏的' 意味着稀疏或分散的。" +
            "<br><br>" +
            "(B) '简短的' 意味着用词节省的；简洁的。" +
    ...
    {
        id: 3,
        question: "His __________ behaviour at the party made everyone uncomfortable.",
        chinese_question: "他在聚会上的__________行为让所有人都感到不舒服。",
        answers: [
    ...
    {
        id: 9,
    question: "Despite his __________ movements on the dance floor, he remained confident and continued to enjoy himself.",
    chinese_question: "尽管在舞池上的动作很 __________，他依然自信并继续享受自己。",
    answers: [
