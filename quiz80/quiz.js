...
var questions = [
    {
        id: 1,
    question: "The detective worked tirelessly to find the __________ child, who had been taken from his home in the middle of the night, and bring them back home safely.",
    chinese_question: "侦探不懈努力寻找在夜里从家中被__________的孩子，并安全地将他们带回家。",
    answers: [
        { option: "A", answer: "lost", chinese_answer: "迷路的", chinese_romanization: "mílù de" },
        ...
        { option: "D", answer: "runaway", chinese_answer: "逃跑的", chinese_romanization: "táopǎo de" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'abducted' means taken away illegally by force or deception; kidnapped." +
        "<br><br>" +
        "(A) 'lost' means unable to find one's way; not knowing one's whereabouts." +
        "<br><br>" +
        "(C) 'hidden' means kept out of sight; concealed." +
        "<br><br>" +
        "(D) 'runaway' means having run away; escaped.",
    chinese_explanation: "(B) '绑架的'一词意味着被非法强行或欺骗带走的；绑架的。" +
        "<br><br>" +
        "(A) '迷路的' 意味着无法找到路的；不知道自己所在位置的。" +
        "<br><br>" +
        "(C) '隐藏的' 意味着隐蔽的；隐藏的。" +
        "<br><br>" +
        "(D) '逃跑的' 意味着逃跑的；逃脱的。"
    ...
    {
        id: 3,
    question: "The goal of the new policy is to __________ the local economy and create jobs.",
    chinese_question: "新政策的目标是 __________ 当地经济并创造就业机会。",
    answers: [
    ...
    {
        id: 8,
        question: "The memory of that day was __________ in her mind forever.",
        chinese_question: "那天的记忆永远 __________ 在她的脑海里。",
        answers: [
        ...
        correctAnswer: "A",
        explanation: "(A) 'inscribed' means to mark or engrave deeply, used figuratively here to mean a memory deeply embedded in someone's mind." +
                "<br><br>" +
        ...
        chinese_explanation: "(A) '铭刻' 意味着深深刻在某物上，这里是比喻用法，表示记忆深深嵌入某人的脑海中。" +
                "<br><br>" +
                "(B) '忽视' 意味着拒绝注意或承认。" +
                "<br><br>" +
                "(C) '擦除' 意味着去除所有痕迹。" +
