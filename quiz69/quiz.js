...
var questions = [
    ...
    answers: [
        ...
        { option: "C", answer: "myth", chinese_answer: "神话", chinese_romanization: "shénhuà" },
        { option: "D", answer: "fallacy", chinese_answer: "谬论", chinese_romanization: "miùlùn" }
    ],
    correctAnswer: "A",
    explanation: "(A) 'principle' means a fundamental truth or proposition that serves as the foundation for a system of belief or behavior or for a chain of reasoning." +
        ...
        "<br><br>" +
        "(C) 'myth' means a traditional story, especially one concerning the early history of a people or explaining a natural or social phenomenon." +
        "<br><br>" +
        "(D) 'fallacy' means a mistaken belief, especially one based on unsound argument.",
    chinese_explanation: "(A) '原则' 意味着作为信仰或行为体系或推理链基础的基本真理或命题。" +
        "<br><br>" +
        "(B) '幻觉' 意味着一种欺骗性的外表或印象。" +
        "<br><br>" +
        "(C) '神话' 意味着一种传统故事，尤指关于一个民族早期历史或解释一种自然或社会现象的故事。" +
        "<br><br>" +
        "(D) '谬论' 意味着一种错误的信念，尤指基于不可靠论据的信念。"
    },
    {
        id: 2,
