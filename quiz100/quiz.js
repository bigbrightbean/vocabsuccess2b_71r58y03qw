...
var questions = [
    ...
    {
        id: 5,
        question: "He likes to __________ the importance of punctuality in every meeting by emphasizing it repeatedly and reminding everyone to arrive on time.",
        chinese_question: "他喜欢在每次会议上通过反复强调并提醒每个人准时到达来 __________ 守时的重要性。",
        answers: [
            ...
            { option: "C", answer: "understate", chinese_answer: "轻描淡写", chinese_romanization: "qīngmiáodànxiě" },
            { option: "D", answer: "belabor", chinese_answer: "反复强调", chinese_romanization: "fǎnfù qiángdiào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'belabour' means to argue or elaborate on a subject excessively." +
            "<br><br>" +
            "(A) 'simplify' means to make something simpler or easier to do or understand." +
            "<br><br>" +
            "(B) 'undermine' means to weaken or damage something." +
            "<br><br>" +
            "(C) 'understate' means to describe something as being smaller or less important than it actually is.",
        chinese_explanation: "(D) '反复强调' 意味着过度地争论或阐述某个主题。" +
            "<br><br>" +
            "(A) '简化' 意味着使某事更简单或更容易做或理解。" +
            "<br><br>" +
            "(B) '削弱' 意味着削弱或损害某物。" +
            "<br><br>" +
            "(C) '轻描淡写' 意味着将某事描述得比实际更小或不重要。"
    },
    {
        id: 6,
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "provoke", chinese_answer: "激怒", chinese_romanization: "jīnù" },
            { option: "B", answer: "agitate", chinese_answer: "使不安", chinese_romanization: "shǐ bù'ān" },
            { option: "C", answer: "frustrate", chinese_answer: "挫败", chinese_romanization: "cuòbài" },
        ...
        explanation: "(D) 'placate' means to make someone less angry or hostile." +
            "<br><br>" +
            "(A) 'provoke' means to stimulate or give rise to a reaction or emotion." +
            "<br><br>" +
            "(B) 'agitate' means to make someone troubled or nervous." +
            "<br><br>" +
            "(C) 'frustrate' means to prevent a plan or action from progressing, succeeding, or being fulfilled.",
    ...
    {
        id: 9,
    question: "She skillfully __________ the difficult questions during the interview by giving vague answers and steering the conversation towards safer topics.",
    chinese_question: "在面试中，她巧妙地通过给出含糊的答案并将谈话引向更安全的话题来 __________ 那些棘手的问题。",
    answers: [
    ...
    {
        id: 10,
    question: "He took steps to __________ any further mistakes in the project, so that the work could proceed smoothly and efficiently.",
    chinese_question: "他采取了措施以 __________ 项目中进一步的错误，以便工作能够顺利高效地进行。",
    answers: [
