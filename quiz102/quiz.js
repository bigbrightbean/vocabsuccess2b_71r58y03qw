...
var questions = [
    ...
    },
    {
        ...
        explanation: "(A) 'spawned' means to generate or bring forth." +
            ...
            "<br><br>" +
            "(D) 'hindered' means to create difficulties, resulting in delay or obstruction.",
    ...
    {
        id: 9,
        question: "The team's confidence did not __________ despite the recent losses.",
        chinese_question: "尽管最近输了比赛，团队的信心并没有 __________。",
        answers: [
    ...
    {
        id: 10,
    question: "The NGO __________ community needs to plan its next humanitarian aid program.",
    chinese_question: "非政府组织 __________ 社区需求，以规划其下一个人道援助项目。",
    answers: [
