...
var questions = [
    ...
    answers: [
        ...
        { option: "B", answer: "placate", chinese_answer: "平息", chinese_romanization: "píngxī" },
    ...
    chinese_explanation: "(B) '平息' 意味着使某人不再生气或敌对。" +
        "<br><br>" +
        "(A) '激怒' 意味着激起或加剧强烈的情感。" +
        "<br><br>" +
        "(C) '驳回' 意味着命令或允许离开；送走。" +
    ...
    {
        id: 10,
        question: "He couldn't help but __________ at the absurdity of the situation.",
        chinese_question: "他忍不住对这种荒谬的情况 __________。",
        answers: [
