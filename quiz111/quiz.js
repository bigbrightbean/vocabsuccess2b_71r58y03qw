...
var questions = [
    ...
    {
        id: 4,
    question: "The increase in sales, along with positive customer feedback, __________ that the new marketing strategy is working.",
    chinese_question: "销售额的增加以及客户的积极反馈 __________ 新的营销策略正在奏效。",
    answers: [
        { option: "A", answer: "denies", chinese_answer: "否认", chinese_romanization: "fǒurèn" },
        { option: "B", answer: "complicates", chinese_answer: "复杂化", chinese_romanization: "fùzáhuà" },
    ...
    explanation: "(D) 'indicates' means to show or point out." +
        ...
        "<br><br>" +
        "(B) 'complicates' means to make something more difficult or confusing by causing it to be more complex." +
        "<br><br>" +
        "(C) 'contradicts' means to assert the opposite of a statement made by someone.",
    chinese_explanation: "(D) '表明' 意味着显示或指出。" +
        "<br><br>" +
        "(A) '否认' 意味着拒绝承认某事的真实性或存在。" +
        "<br><br>" +
        "(B) '复杂化' 意味着通过使某事更复杂来使其更困难或令人困惑。" +
        "<br><br>" +
        "(C) '反驳' 意味着断言某人所作声明的相反。"
    },
    {
    ...
    {
        id: 6,
        question: "We will __________ the land before starting the construction project by measuring boundaries and assessing the terrain.",
        chinese_question: "我们将在开始建设项目之前通过测量边界和评估地形来 __________ 这片土地。",
        answers: [
    ...
    {
        id: 7,
    question: "With passionate rhetoric and fiery words, the leader's speech __________ the crowd, leading to an unexpected protest in the streets.",
    chinese_question: "领导通过激情澎湃的言辞和火热的语言 __________ 了人群，导致街头出现了意想不到的抗议活动。",
    answers: [
