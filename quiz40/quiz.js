...
var questions = [
    {
        id: 1,
        question: "As the only child, she took on the __________ responsibility of caring for her elderly parents, which required her full dedication and time.",
        chinese_question: "作为独生子女，她承担了照顾年迈父母的 __________ 责任，这需要她全身心的投入和时间。",
        answers: [
    ...
    {
        id: 2,
        question: "Even though she meant well, her __________ efforts to help, such as reorganizing the workspace and taking over tasks without permission, often resulted in more chaos than assistance.",
        chinese_question: "尽管她本意是好的，但她 __________ 的帮助努力，例如重新组织工作空间和未经许可接手任务，经常导致更多的混乱而不是帮助。",
        answers: [
