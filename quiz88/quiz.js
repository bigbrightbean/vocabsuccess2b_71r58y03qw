...
var questions = [
    ...
    },
    {
        ...
        correctAnswer: "A",
        explanation: "(A) 'gallivant' means to go around from one place to another in the pursuit of pleasure or entertainment." +
                "<br><br>" +
                "(B) 'work' means to be engaged in physical or mental activity in order to achieve a purpose or result." +
                "<br><br>" +
                "(C) 'ignore' means to refuse to take notice of or acknowledge." +
                "<br><br>" +
                "(D) 'sleep' means to rest with the eyes closed and the mind and body inactive.",
