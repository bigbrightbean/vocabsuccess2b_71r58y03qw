...
var questions = [
    ...
    },
    {
        ...
        answers: [
                ...
                { option: "C", answer: "mediator", chinese_answer: "调解员", chinese_romanization: "tiáojiěyuán" },
        ...
        explanation: "(B) 'liaison' means communication or cooperation that facilitates a close working relationship between people or organizations." +
                ...
                "<br><br>" +
                "(C) 'mediator' means a person who attempts to make people involved in a conflict come to an agreement." +
                "<br><br>" +
    ...
    {
        id: 10,
    question: "He made several __________ to start his own business before finally succeeding.",
    chinese_question: "他尝试了几次创业，最终才成功。",
    answers: [
