...
var questions = [
    ...
    answers: [
        ...
        { option: "B", answer: "labyrinth", chinese_answer: "迷宫", chinese_romanization: "mígōng" },
    ...
    explanation: "(A) 'hoard' means a stock or store of money or valued objects, typically one that is secret or carefully guarded." +
        "<br><br>" +
        "(B) 'labyrinth' means a complicated irregular network of passages or paths in which it is difficult to find one's way; a maze." +
        "<br><br>" +
        "(C) 'quagmire' means a soft boggy area of land that gives way underfoot." +
        "<br><br>" +
        "(D) 'scattering' means an act of spreading something over an area.",
    chinese_explanation: "(A) '囤积' 意味着一批货币或有价值的物品，通常是秘密或精心守护的。" +
        "<br><br>" +
        "(B) '迷宫' 意味着一个复杂的不规则通道或路径网络，很难找到出路。" +
        "<br><br>" +
        "(C) '泥潭' 意味着一块松软的沼泽地。" +
        "<br><br>" +
    ...
    {
        id: 4,
        question: "His __________ for classical music was evident, as his playlist was filled with symphonies and operas rather than contemporary hits.",
        chinese_question: "他对古典音乐的 __________ 显而易见，因为他的播放列表里全是交响乐和歌剧，而不是当代流行歌曲。",
        answers: [
            ...
            { option: "C", answer: "indifference", chinese_answer: "冷漠", chinese_romanization: "lěnmò" },
            { option: "D", answer: "predilection", chinese_answer: "偏爱", chinese_romanization: "piān'ài" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'predilection' means a preference or special liking for something; a bias in favor of something." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '偏爱' 意味着对某事的偏好或特别喜欢；偏袒。" +
            "<br><br>" +
            "(A) '不喜欢' 意味着一种厌恶或敌意的感觉。" +
            "<br><br>" +
            "(B) '厌恶' 意味着强烈的厌恶或不情愿。" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "signal", chinese_answer: "信号", chinese_romanization: "xìnhào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'signal' means a gesture, action, or sound that is used to convey information or instructions." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '信号' 意味着用来传达信息或指示的手势、动作或声音。" +
            "<br><br>" +
            "(A) '谜' 意味着难以理解或解释的事情。" +
            "<br><br>" +
            "(B) '错误' 意味着一个错误。" +
