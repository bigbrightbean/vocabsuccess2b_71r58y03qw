...
var questions = [
    {
        id: 1,
        question: "The report __________ the challenges the company faces in the coming years, by highlighting potential risks and offering strategies for mitigation.",
        chinese_question: "该报告通过强调潜在风险并提供缓解策略 __________ 了公司未来几年面临的挑战。",
        answers: [
    ...
    {
        id: 4,
        question: "The professor asked the students to __________ the main points of the lecture by listing each topic covered and providing a brief explanation.",
        chinese_question: "教授要求学生通过列出每个涵盖的主题并提供简要说明来 __________ 讲座的要点。",
        answers: [
            ...
            { option: "C", answer: "enumerate", chinese_answer: "列举", chinese_romanization: "lièjǔ" },
            { option: "D", answer: "confuse", chinese_answer: "迷惑", chinese_romanization: "míhuò" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'enumerate' means to mention (a number of things) one by one." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '列举' 意味着一一提到（若干事情）。" +
            "<br><br>" +
            "(A) '忽视' 意味着未能注意到某事。" +
            "<br><br>" +
    ...
    {
        id: 9,
    question: "During his passionate speech, the coach would __________ wildly, waving his arms and pointing at the players to emphasize his points.",
    chinese_question: "在他激情洋溢的演讲中，教练会疯狂地 __________，挥舞着手臂并指着球员以强调他的观点。",
    answers: [
        { option: "A", answer: "mumble", chinese_answer: "咕哝", chinese_romanization: "gūnóng" },
        ...
        { option: "D", answer: "gesticulate", chinese_answer: "做手势", chinese_romanization: "zuò shǒushì" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'gesticulate' means to use gestures, especially dramatic ones, instead of speaking or to emphasize one's words." +
        "<br><br>" +
        "(A) 'mumble' means to speak indistinctly and quietly." +
        "<br><br>" +
        "(B) 'whisper' means to speak very softly using one's breath without vocal cords." +
        "<br><br>" +
        "(C) 'suppress' means to prevent the development, action, or expression of something.",
    chinese_explanation: "(D) '做手势' 意味着用手势代替说话或强调自己的话，尤其是戏剧性的手势。" +
        "<br><br>" +
        "(A) '咕哝' 意味着含糊不清地小声说话。" +
        "<br><br>" +
        "(B) '低语' 意味着用气息轻声说话，不用声带。" +
        "<br><br>" +
        "(C) '压制' 意味着阻止某事的发展、行动或表达。"
    },
    {
        id: 10,
