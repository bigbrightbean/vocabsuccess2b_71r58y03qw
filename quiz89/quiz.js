...
var questions = [
    {
        id: 1,
        question: "The urgent nature of the situation required them to __________ help immediately by sending a rescue team and an ambulance.",
        chinese_question: "情况的紧迫性要求他们立即 __________ 帮助，派遣救援队和救护车。",
        answers: [
    ...
    {
        id: 4,
    question: "While sitting by the lake, he began to __________ on the meaning of life by reflecting on his experiences and contemplating his future.",
    chinese_question: "坐在湖边时，他开始 __________ 生命的意义，反思自己的经历并思考未来。",
    answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "erased", chinese_answer: "擦除", chinese_romanization: "cāchú" },
            { option: "C", answer: "juxtaposed", chinese_answer: "并列", chinese_romanization: "bìngliè" },
            { option: "D", answer: "separated", chinese_answer: "分开", chinese_romanization: "fēnkāi" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'juxtaposed' means to place side by side for contrast, used figuratively here." +
            "<br><br>" +
            "(A) 'supported' means to give assistance to." +
            "<br><br>" +
            "(B) 'erased' means to remove all traces of something." +
            "<br><br>" +
            "(D) 'separated' means to cause to move or be apart.",
        chinese_explanation: "(C) '并列' 意味着并排放置以作对比，这里是比喻用法。" +
            "<br><br>" +
            "(A) '支持' 意味着给予帮助。" +
            "<br><br>" +
            "(B) '擦除' 意味着去除所有痕迹。" +
    ...
    answers: [
        { option: "A", answer: "obfuscated", chinese_answer: "使混乱", chinese_romanization: "shǐ hùnluàn" },
        { option: "B", answer: "disregarded", chinese_answer: "忽视", chinese_romanization: "hūshì" },
    ...
    explanation: "(C) 'exhorted' means to strongly encourage or urge someone to do something." +
        "<br><br>" +
        "(A) 'obfuscated' means to render obscure, unclear, or unintelligible." +
        "<br><br>" +
        "(B) 'disregarded' means to pay no attention to; ignore." +
        "<br><br>" +
