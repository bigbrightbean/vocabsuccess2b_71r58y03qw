...
var questions = [
    ...
    {
        id: 5,
        question: "The leader’s optimism was __________ by the knowledge of the challenges that lay ahead.",
        chinese_question: "领导者的乐观情绪因知道前方的挑战而得到 __________。",
        answers: [
    ...
    {
        id: 6,
        question: "The CEO's __________ to oust the board members was revealed in a series of leaked emails.",
        chinese_question: "泄露的一系列电子邮件揭示了首席执行官驱逐董事会成员的 __________。",
        answers: [
